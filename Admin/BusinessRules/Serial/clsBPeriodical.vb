    ...
    Public Class clsBPeriodical
        ...
        Public Function GetPeriodicalInfor() As DataTable
            Try
                ...
                GetPeriodicalInfor = objBCDBS.ConvertTable(GetPeriodicalInfor, "FIELD300", False)
                intErrorCode = objDPeriodical.ErrorCode
                strErrorMsg = objDPeriodical.ErrorMsg
            Catch ex As Exception
                strErrorMsg = ex.Message
        ...
        ' Input: ItemID
        ' Output: datatable result
        Public Function GetReceivedVolume(ByVal intYear As Integer, Optional ByVal intMonth As Integer = 0) As DataTable
            Try
                objDPeriodical.ItemID = lngItemID
                GetReceivedVolume = objBCDBS.ConvertTable(objDPeriodical.GetReceivedVolume(intYear, intMonth))
                intErrorCode = objDPeriodical.ErrorCode
                strErrorMsg = objDPeriodical.ErrorMsg
            Catch ex As Exception
                strErrorMsg = ex.Message
        ...
        ' Output: datatable result
        Public Function GetReceivedIssues(ByVal intYear As Integer, ByVal strVolumeByPublisher As String, Optional ByVal intMonth As Integer = 0) As DataTable
            Try
                objDPeriodical.ItemID = lngItemID
                GetReceivedIssues = objBCDBS.ConvertTable(objDPeriodical.GetReceivedIssues(intYear, Trim(objBCSP.ConvertItBack(strVolumeByPublisher)), intMonth))
                intErrorCode = objDPeriodical.ErrorCode
                strErrorMsg = objDPeriodical.ErrorMsg
            Catch ex As Exception
                strErrorMsg = ex.Message
        ...
        Public Function GetReceivedIssuesByYear(ByVal intYear As Integer, ByRef strDOWs As String, ByRef strBasedDate As String, ByRef strCeasedDate As String) As DataTable
            ...
            Try
                objDPeriodical.ItemID = lngItemID
                objDPeriodical.LocationID = intLocationID
                tblResult = objBCDBS.ConvertTable(objDPeriodical.GetReceivedIssuesByYear(intYear, strDOWs, strBasedDate, strCeasedDate))
                If Not tblResult Is Nothing AndAlso tblResult.Rows.Count > 0 Then
                    ...
                    Next
                End If
                GetReceivedIssuesByYear = tblResult
        ...
        Public Sub GetIssuesMoneyByYear(ByVal intYear As Integer, ByRef flprice1 As Double, ByRef flprice2 As Double, ByRef flprice3 As Double, ByRef flprice4 As Double)
            Try
                objDPeriodical.ItemID = lngItemID
                objDPeriodical.LocationID = intLocationID
                objDPeriodical.GetIssuesMoneyByYear(intYear, flprice1, flprice2, flprice3, flprice4)
                intErrorCode = objDPeriodical.ErrorCode
                strErrorMsg = objDPeriodical.ErrorMsg
            Catch ex As Exception
                strErrorMsg = ex.Message
        ...
        Public Sub GetReceiveIssueNums(ByVal intYear As Integer, ByRef intResetReg As Integer, ByRef strMonths As String, ByRef strHavingYearIssue As String, ByRef strFirstIssueInYear As String)
            Try
                objDPeriodical.ItemID = lngItemID
                objDPeriodical.LocationID = intLocationID
                Call objDPeriodical.GetReceiveIssueNums(intYear, intResetReg, strMonths, strHavingYearIssue, strFirstIssueInYear)
        ...
        Public Sub GetReceiveIssueForStatic(ByVal strFromDate As String, ByVal strToDate As String, ByRef intResetReg As Integer, ByRef strMonths As String, ByRef strHavingYearIssue As String)
            Try
                objDPeriodical.ItemID = lngItemID
                strFromDate = objBCDBS.ConvertDateBack(strFromDate)
                strToDate = objBCDBS.ConvertDateBack(strToDate)
                Call objDPeriodical.GetReceiveIssueForStatic(strFromDate, strToDate, intResetReg, strMonths, strHavingYearIssue)
                intErrorCode = objDPeriodical.ErrorCode
                strErrorMsg = objDPeriodical.ErrorMsg
            Catch ex As Exception
                strErrorMsg = ex.Message
