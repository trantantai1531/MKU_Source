...
Namespace eMicLibAdmin.BusinessRules
    Public Class clsBHelp
        Inherits clsBBase
        ' *************************************************************************************************
        ' Declare Private variables
        ' *************************************************************************************************
        Private objDHelp As New clsDHelp
        ...
        '
        ' Name: GetInforSearch
        ' Purpose: GetRoot treeview
        ' Input: Root,Type
        ' Output: Datatable
        ' Creator: thaott
        ' Created Date: 7/Sep/2006
        ' Modification History:    
        '
        ...
        Public Function GetRootDic() As DataTable
            Try
                objDHelp.SQL = "Select * from Lib_tblHelpCatDic where Root=" & blnRoot & " And Type=" & inttype
        ...
        End Function
        ' Name: DeleteHelp
        ' Purpose: Delete data help in all table in database
        ' Input: intCatDicID
        ' Output: Boolean
        ' Creator: thaott
        ' Created Date: 5/Sep/2006
        ' Modification History:         '
        ...
        ' Output: interger 0--Update successful,1 error parent=catDicID, 2 error file is used by other catdicID
        ' Creator: thaott
        ...
        Public Function InsertHelp() As Integer
            ...
            'End Try
        End Function
        ' Name: GetAllChildHepDicByParentID
        ' Purpose: Get all children help Dic by ParentID 
        ' Input: intCatDicID
        ' Output: DataTable
        ' Creator: thaott
        ...
        ' Purpose: Get Lib_tblHelpCatDic infor 
        ' Input: intCatDicID
        ' Output: DataTable
        ' Creator: thaott
        ' Created Date: 30/Aug/2006
