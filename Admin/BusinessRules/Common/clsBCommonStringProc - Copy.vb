...
Namespace eMicLibAdmin.BusinessRules.Common
    Public Class clsBCommonStringProc
        ...
        Private Function CJKSplitter(ByVal strInput As String)
                    ...
                    If Not IsNothing(SubRecsTemp) Then
                        ...
                        For i = 0 To UBound(SubRecsTemp) - 1
                            If SubRecsTemp(i).Trim <> "" Then
                                ...
                                If strTemp <> "" Then
                                    strTemp = DoubleSingleQuote(strTemp)
        ...
        Private Function setSubField(ByVal strField As String, ByVal value As String) As String
            ...
            Try
                ...
                ElseIf (strField = "245") AndAlso InStr(value, "$c") > 0 Then
                    'strResult &= strSpace & "/" & strDollar & value
                    strResult = Replace(value, "$c", strSpace & "/" & "$c")
                ElseIf (strField = "245") AndAlso InStr(value, "$n") > 0 Then
                    'strResult &= strSpace & "." & strDollar & value
                    strResult = Replace(value, "$n", strSpace & "." & "$n")
                ElseIf (strField = "245") AndAlso InStr(value, "$p") > 0 Then
                    'strResult &= strSpace & "," & strDollar & value
                    strResult = Replace(value, "$p", strSpace & "," & "$p")
                ...
                ElseIf (strField = "100") AndAlso InStr(value, "$d") > 0 Then
                    strResult &= strSpace & "," & strDollar & value
                    strResult = Replace(value, "$d", strSpace & "," & "$d")
                ...
                ElseIf (strField = "440$x") AndAlso InStr(value, "$x") > 0 Then
                    'strResult &= strSpace & "," & strDollar & value
                    strResult = Replace(value, "$x", strSpace & "," & "$x")
                ElseIf (strField = "650") AndAlso InStr(value, "$2") > 0 Then
                    'strResult &= strSpace & "." & strDollar & value
                    strResult = Replace(value, "$2", strSpace & "." & "$2")
        ...
        Public Sub concatValueSubFields(ByVal strSubField As String, ByVal value As String, ByRef strResult As String)
            Try
                value = value.Trim
                If InStr(strSubField, "$a") > 0 Then
                    If value <> "" AndAlso value <> "::" AndAlso value <> "::$&" Then
                        If strResult <> "" Then
                            If InStr(strSubField, "$") > 0 Then
                                Dim strDollarNumber As String = strResult.Substring(InStr(strResult, "$"), 1)
                                If IsNumeric(strDollarNumber) Then
                ...
                Else
                    If value <> "" AndAlso value <> "$&" Then
                        If InStr(strSubField, "$") > 0 Then
                            Dim strDollar As String = strSubField.Substring(InStr(strSubField, "$") - 1)
                            Dim strSpace As String = Space(1)
                            If (strSubField = "245$b") Then
                                strResult &= AddDeliminator(strSpace & ":" & strDollar, value)
                            ElseIf (strSubField = "245$n") Then
                                'strResult &= strSpace & "." & strDollar & value
                                strResult &= AddDeliminator(strSpace & "." & strDollar, value)
                            ElseIf (strSubField = "245$p") Then
                                'strResult &= strSpace & "," & strDollar & value
                                strResult &= AddDeliminator(strSpace & "," & strDollar, value)
                            ElseIf (strSubField = "245$c") Then
                                'strResult &= strSpace & "/" & strDollar & value
                                strResult &= AddDeliminator(strSpace & "/" & strDollar, value)
                            ElseIf (strSubField = "020$c") Then
                                'strResult &= strSpace & ":" & strDollar & value
                                strResult &= AddDeliminator(strSpace & ":" & strDollar, value)
                            ElseIf (strSubField = "100$b") Then
                                'strResult &= strSpace & "," & strDollar & value
                                strResult &= AddDeliminator(strSpace & "," & strDollar, value)
                            ElseIf (strSubField = "100$c") Then
                                'strResult &= strSpace & "," & strDollar & value
                                strResult &= AddDeliminator(strSpace & "," & strDollar, value)
                            ElseIf (strSubField = "100$d") Then
                                strResult &= strSpace & "," & strDollar & value
                                strResult &= AddDeliminator(strSpace & ":" & strDollar, value)
                            ElseIf (strSubField = "110$b") Then
                                'strResult &= strSpace & "." & strDollar & value
                                strResult &= AddDeliminator(strSpace & "." & strDollar, value)
                            ElseIf (strSubField = "020$c") Then
                                'strResult &= strSpace & ":" & strDollar & value
                                strResult &= AddDeliminator(strSpace & ":" & strDollar, value)
                            ElseIf (strSubField = "250$b") Then
                                'strResult &= strSpace & "/" & strDollar & value
                                strResult &= AddDeliminator(strSpace & "/" & strDollar, value)
                            ElseIf (strSubField = "260$b") Then
                                'strResult &= strSpace & ":" & strDollar & value
                                strResult &= AddDeliminator(strSpace & ":" & strDollar, value)
                            ElseIf (strSubField = "260$c") Then
                                'strResult &= strSpace & "," & strDollar & value
                                strResult &= AddDeliminator(strSpace & "," & strDollar, value)
                            ElseIf (strSubField = "300$b") Then
                                'strResult &= strSpace & ":" & strDollar & value
                                strResult &= AddDeliminator(strSpace & ":" & strDollar, value)
                            ElseIf (strSubField = "300$c") Then
                                'strResult &= strSpace & ";" & strDollar & value
                                strResult &= AddDeliminator(strSpace & ";" & strDollar, value)
                            ElseIf (strSubField = "300$e") Then
                                'strResult &= strSpace & "+" & strDollar & value
                                strResult &= AddDeliminator(strSpace & "+" & strDollar, value)
                            ElseIf (strSubField = "440$b") Then
                                'strResult &= strSpace & ":" & strDollar & value
                                strResult &= AddDeliminator(strSpace & ":" & strDollar, value)
                            ElseIf (strSubField = "440$v") Then
                                'strResult &= strSpace & ";" & strDollar & value
                                strResult &= AddDeliminator(strSpace & ";" & strDollar, value)
                            ElseIf (strSubField = "440$n") Then
                                'strResult &= strSpace & "." & strDollar & value
                                strResult &= AddDeliminator(strSpace & "." & strDollar, value)
                            ElseIf (strSubField = "440$p") Then
                                'strResult &= strSpace & "," & strDollar & value
                                strResult &= AddDeliminator(strSpace & "," & strDollar, value)
                            ElseIf (strSubField = "440$x") Then
                                'strResult &= strSpace & "," & strDollar & value
                                strResult &= AddDeliminator(strSpace & "," & strDollar, value)
                            ElseIf (strSubField = "650$2") Then
                                'strResult &= strSpace & "." & strDollar & value
                                strResult &= AddDeliminator(strSpace & "." & strDollar, value)
                            ElseIf (strSubField = "650$b") Then
                                'strResult &= strSpace & "." & strDollar & value
                                strResult &= AddDeliminator(strSpace & "." & strDollar, value)
                            ElseIf (strSubField = "650$e") Then
                                'strResult &= strSpace & "," & strDollar & value
                                strResult &= AddDeliminator(strSpace & "," & strDollar, value)
                            Else
                                'strResult &= strSpace & strDollar & value
                        ...
                        If Not IsNothing(SubRecsTemp) Then
                            For ii As Integer = 0 To UBound(SubRecsTemp)
                                If SubRecsTemp(ii).Trim <> "" AndAlso strArrDollar(ii) = strDollar Then
                                    ...
                                    If (strTag = "245$b" Or strTag = "245$c" Or strTag = "245$n" Or strTag = "245$p") Then
                                        strResult = Trim(GEntryTrim(strResult))
                                    Else
                                        strResult = Trim(GEntryTrimExp1(strResult))
                                    End If

                                    strResult = DoubleSingleQuote(strResult)
                                    Exit For
                                End If
                            Next
                        End If
