...
Namespace Libol60.DataAccess
    Public Class clsDOPACHelp
        Inherits clsDBase
        ' *************************************************************************************************
        ...
        Public Function GetInfor() As DataTable
            ...
            Select Case UCase(strDBServer)
                ...
                Case "ORACLE"
                    With oraCommand
                        .CommandText = "OPAC.SP_Help_ExcuteSQL"
                        .CommandType = CommandType.StoredProcedure
                        Try
                            With .Parameters
        ...
        Public Function GetHepCatFileByURL() As DataTable
            ...
            Select Case UCase(strDBServer)
                Case "SQLSERVER"
                    With SqlCommand
                        .CommandText = "SP_HELP_CAT_FILE_SELECT_BYURL"
                        .CommandType = CommandType.StoredProcedure
                        Try
                            With .Parameters
        ...
        Public Function GetHepCatFileByDicID() As DataTable
            ...
            Select Case UCase(strDBServer)
                Case "SQLSERVER"
                    With SqlCommand
                        .CommandText = "SP_HELP_CAT_FILE_SELECT_BYDICID"
                        .CommandType = CommandType.StoredProcedure
                        Try
                            With .Parameters
        ...
        Public Function GetHepCatDicByID() As DataTable
            ...
            Select Case UCase(strDBServer)
                Case "SQLSERVER"
                    With SqlCommand
                        .CommandText = "SP_HELP_CAT_DIC_SELECT_BYDICID"
                        .CommandType = CommandType.StoredProcedure
                        Try
                            With .Parameters
        ...
        Public Function GetHepItemLinkByID() As DataTable
            ...
            Select Case UCase(strDBServer)
                Case "SQLSERVER"
                    With SqlCommand
                        .CommandText = "SP_HELP_ITEM_LINK_SELECT_BYDICID"
                        .CommandType = CommandType.StoredProcedure
                        Try
                            With .Parameters
                                .Add(New SqlParameter("@intCatDicID", SqlDbType.Int)).Value = intCatDicID
        ...
        ' Purpose: Get  HELP_DIC_ITEM infor
        ' Input: intCatDicID
        ' Output: DataTable
        ' Creator: thaott
        ' Created Date: 30/Aug/2006
        ...
        Public Function GetHepDicItemByID() As DataTable
            ...
            Select Case UCase(strDBServer)
                Case "SQLSERVER"
                    With SqlCommand
                        .CommandText = "SP_HELP_DIC_ITEM_SELECT_BYID"
                        .CommandType = CommandType.StoredProcedure
                        Try
                            With .Parameters
                                .Add(New SqlParameter("@intCatDicID", SqlDbType.Int)).Value = intCatDicID
        ...
        Public Function GetHepCatDicByParentID() As DataTable
            ...
            Select Case UCase(strDBServer)
                Case "SQLSERVER"
                    With SqlCommand
                        .CommandText = "SP_HELP_CAT_DIC_SELECT_BYPARENTID"
                        .CommandType = CommandType.StoredProcedure
                        Try
                            With .Parameters
