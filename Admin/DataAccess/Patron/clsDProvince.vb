    ...
    Public Class clsDProvince
        ...
        Public Function GetProvince() As DataTable
            ...
            Select Case UCase(strDBServer)
                Case "SQLSERVER"
                    With SqlCommand
                        .CommandText = "Cir_spPatGetProvince"
                ...
                Case "ORACLE"
                    With oraCommand
                        .CommandText = "PATRON.SP_PAT_GET_PROVINCE"
                        .CommandType = CommandType.StoredProcedure
                        Try
                            With .Parameters
        ...
        Public Function Create() As Integer
            ...
            Select Case UCase(strDBServer)
                Case "SQLSERVER"
                    With SqlCommand
                        .CommandText = "Cir_spPatCreateProvince"
                        .CommandType = CommandType.StoredProcedure
                        Try
                            With .Parameters
                                .Add(New SqlParameter("@strProvince", SqlDbType.NVarChar, 50)).Value = strProvince
                ...
                Case "ORACLE"
                    With OraCommand
                        .CommandText = "PATRON.SP_PAT_CREATE_PROVINCE"
                        .CommandType = CommandType.StoredProcedure
                        Try
                            With .Parameters
                                .Add(New OracleParameter("strProvince", OracleType.VarChar, 50)).Value = strProvince
        ...
        Public Function Update() As Integer
            ...
            Select Case UCase(strDBServer)
                Case "SQLSERVER"
                    With SqlCommand
                        .CommandText = "Cir_spPatUpdateProvince"
                        .CommandType = CommandType.StoredProcedure
                        Try
                            With .Parameters
                ...
                Case "ORACLE"
                    With OraCommand
                        .CommandText = "PATRON.SP_PAT_UPDATE_PROVINCE"
                        .CommandType = CommandType.StoredProcedure
                        Try
                            With .Parameters
        ...
        Public Sub Merger()
            ...
            Select Case UCase(strDBServer)
                Case "SQLSERVER"
                    With SqlCommand
                        .CommandText = "Cir_spPatMergeProvince"
                        .CommandType = CommandType.StoredProcedure
                        Try
                            With .Parameters
                                .Add(New SqlParameter("@intID", SqlDbType.Int)).Value = intID
                ...
                Case "ORACLE"
                    With OraCommand
                        .CommandText = "PATRON.SP_PAT_MERGER_PROVINCE"
                        .CommandType = CommandType.StoredProcedure
                        Try
                            With .Parameters
                                .Add(New OracleParameter("intID", OracleType.Number)).Value = intID
        ...
        Public Sub Delete()
            ...
            Select Case UCase(strDBServer)
                Case "SQLSERVER"
                    With SqlCommand
                        .CommandText = "Cir_spDicProvince_DelById"
                        .CommandType = CommandType.StoredProcedure
                        Try
                            With .Parameters
                                .Add(New SqlParameter("@intID", SqlDbType.Int)).Value = intID
                ...
                Case "ORACLE"
                    With OraCommand
                        .CommandText = "PATRON.SP_CIR_DIC_PROVINCE_DELETE"
                        .CommandType = CommandType.StoredProcedure
                        Try
                            With .Parameters
                                .Add(New OracleParameter("intID", OracleType.Number)).Value = intID
