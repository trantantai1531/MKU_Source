...
function CheckAllOptionsSelectVisible(strDtgName, strOptionName, intStart, intMax) {
    var intCounter;
    var blnStatus;
    blnStatus = false;

    if (eval('document.forms[0].CheckAllSelect')) {
        if (eval('document.forms[0].CheckAllSelect').checked)
            blnStatus = true;
    }
    else {
        if (eval('document.forms[0].chkCheckAllSelect')) {
            if (eval('document.forms[0].chkCheckAllSelect').checked)
                blnStatus = true;
        }
    }
