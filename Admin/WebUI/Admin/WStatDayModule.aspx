<%@ Page Language="vb" AutoEventWireup="false" Inherits="eMicLibAdmin.WebUI.Admin.WStatDayModule" CodeFile="WStatDayModule.aspx.vb" CodeFileBaseClass="eMicLibAdmin.WebUI.clsWBase" %>
<!DOCTYPE HTML PUBLIC "-//W3C//DTD HTML 4.0 Transitional//EN">
<HTML>
	<HEAD>
		<title>WStatDayModule</title>
		...
		<form id="Form2" method="post" runat="server">
			<table id="tblStat" width="100%" align="center" border="0" runat="server">
				<tr Class="lbPageTitle">
					<td colspan="2"><asp:label id="lblPageTitle" Runat="server" CssClass="lbPageTitle" Width="100%">Thống kê Log các phân hệ trong ngày&nbsp;</asp:label></td>
				</tr>
				<tr>
			...
			<input type="hidden" id="hidYear" runat="server"> <input type="hidden" id="hidType" runat="server">
			<asp:DropDownList Runat="server" ID="ddlLabel" Width="0" Height="0" Visible="False">
				<asp:ListItem Value="0">Chi tiết lỗi</asp:ListItem>
				<asp:ListItem Value="1">Mã lỗi</asp:ListItem>
				<asp:ListItem Value="2">Thống kê Log các phân hệ trong ngày&nbsp;</asp:ListItem>
				<asp:ListItem Value="3">Không có dữ liệu thoả mãn</asp:ListItem>
				<asp:ListItem Value="4">Phân hệ</asp:ListItem>
				<asp:ListItem Value="5">Số lượng giao dịch</asp:ListItem>
				<asp:ListItem Value="6">Tỷ lệ số lượng giao dịch giữa các phân hệ</asp:ListItem>
			</asp:DropDownList>
		</form>
	</body>
</HTML>
