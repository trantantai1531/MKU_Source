...
<ComponentArt:Dialog
  ...
  <Content>
    ...
    <div class="ts">
      <div class="ts-l"></div>
      <div class="ts-m">
        <a href="javascript:void(0);" class="tab-sel" onclick="toggle_dialog_tab(this,<%=HyperlinkDialog.ClientID%>,0,'tab-sel','tab');this.blur();" title="Edit link details"><img src="<%=Me.Attributes("SkinFolderLocation")%>/images/_blank.png" width="16" height="16" alt="Link icon" class="icon link" /><span class="link">Link</span></a>
        <a href="javascript:void(0);" class="tab" onclick="toggle_dialog_tab(this,<%=HyperlinkDialog.ClientID%>,1,'tab-sel','tab');this.blur();" title="Edit anchor details"><img src="<%=Me.Attributes("SkinFolderLocation")%>/images/_blank.png" width="16" height="16" alt="Anchor icon" class="icon anchor" /><span class="anchor">Anchor</span></a>
        <a href="javascript:void(0);" class="tab" onclick="toggle_dialog_tab(this,<%=HyperlinkDialog.ClientID%>,2,'tab-sel','tab');this.blur();" title="Edit email details"><img src="<%=Me.Attributes("SkinFolderLocation")%>/images/_blank.png" width="16" height="16" alt="Email icon" class="icon email" /><span class="email">Email</span></a>
      </div>
      <div class="ts-r"></div>
    </div>
      ...
      <ComponentArt:MultiPage ID="HyperlinkPages" RunAt="server">
        <ComponentArt:PageView ID="Link" RunAt="server">
          <div class="row top" title="Required">
            <span class="label">Link URL:</span><input id="<%=Me.ClientID%>_link_url" type="text" class="link-url" /><a href="javascript:void(0);" onclick="check_url(this);this.blur();" class="preview-url" title="Preview URL in new window"></a>
          </div>

          <div class="row">
            <span class="label">Link Text:</span><input type="text" id="<%=Me.ClientID%>_link_text" class="link-text" />
            <span class="label-narrow" title="Optional">Target:</span><input id="<%=Me.ClientID%>_link_target" type="text" class="link-target f-l" title="Optional" />
          </div>
          ...
          <div class="row">
            ...
            <input type="text" id="<%=Me.ClientID%>_link_type_other" class="link-type-other f-l disabled" disabled="disabled" />
          </div>
        ...
        <ComponentArt:PageView ID="Anchor" RunAt="server">
          <div class="row top"><span class="label">Name:</span><input type="text" id="<%=Me.ClientID%>_anchor_name" class="anchor-name" /></div>
          <div class="row"><span class="label">Text:</span><input type="text" id="<%=Me.ClientID%>_anchor_text" class="anchor-text" /></div>
        </ComponentArt:PageView>

        <ComponentArt:PageView  id="Email" RunAt="server">
          <div class="row top"><span class="label">Address:</span><input type="text" id="<%=Me.ClientID%>_email_address" class="email-address" /></div>
          <div class="row"><span class="label">Subject:</span><input type="text" id="<%=Me.ClientID%>_email_subject" class="email-subject" /></div>
          <div class="row" title="Optional">
            <span class="label">Link Text:</span><input type="text" id="<%=Me.ClientID%>_email_text" class="email-text" />
    ...
    <div class="ftr">
      <div class="ftr-l"></div>
      <div class="ftr-m">
        <a onclick="toggle_hyperlink_options(this,<%=HyperlinkDialog.ClientID%>);this.blur();return false;" href="javascript:void(0);" id="<%=Me.ClientID%>_hyperlink-options" class="btn70 f-l"><span class="advanced">Advanced</span></a>
