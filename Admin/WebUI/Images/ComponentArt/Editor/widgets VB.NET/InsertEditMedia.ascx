...
<ComponentArt:Dialog
  ...
  <Content>
    ...
    <div class="ts">
      <div class="ts-l"></div>
      <div class="ts-m">
        <a href="javascript:void(0);" class="tab-sel" onclick="toggle_dialog_tab(this,<%=MediaDialog.ClientID%>,0);this.blur();" title="Edit image details"><img src="<%=Me.Attributes("SkinFolderLocation")%>/images/_blank.png" width="16" height="16" alt="Image icon" class="icon image" /><span class="image">Image</span></a>
      </div>
      <div class="ts-r"></div>
    </div>
      ...
      <div class="con-m">
        ...
        <ComponentArt:MultiPage Id="MediaPages" RunAt="server">
          <ComponentArt:PageView RunAt="server" id="Image">
            <div class="fields">
              <div class="row top" title="Required"><span class="label">Image URL:</span><input type="text" class="image-url" id="<%=Me.ClientID%>_image_url" /><a href="javascript:void(0);" onclick="load_image(this,<%=MediaDialog.ClientID%>);this.blur();" class="preview-url" title="Preview this image"></a></div>

              <div class="row" title="Required"><span class="label">Image Description:</span><input type="text" class="image-desc" id="<%=Me.ClientID%>_image_desc" /></div>

              <div class="row" title="Required">
              <span class="label">Width:</span><input type="text" class="image-width" id="<%=Me.ClientID%>_image_width" />
              <span class="label-narrow">Height:</span><input type="text" class="image-height float-left" id="<%=Me.ClientID%>_image_height" />
              </div>
              ...
              <div class="row" title="Optional">
                ...
                <span class="label-narrow">Border:</span><input type="text" class="image-border float-left" id="<%=Me.ClientID%>_image_border" />
              </div>

              <div class="hr"><span></span></div>

              <div class="row" title="Optional">
                <span class="label">Horizontal Spacing:</span><input type="text" class="image-hspace" id="<%=Me.ClientID%>_image_hspace" />
                <span class="label">Vertical Spacing:</span><input type="text" class="image-vspace float-left" id="<%=Me.ClientID%>_image_vspace" />
              </div>

              <div class="row" title="Optional"><span class="label">CSS Class:</span><input id="<%=Me.ClientID%>_image_cssclass" type="text" class="image-class" /></div>
              <div class="row" title="Optional"><span class="label">Inline CSS:</span><input id="<%=Me.ClientID%>_image_inline" type="text" class="image-inline" /></div>
            </div>
...
<%=MediaDialog.ClientID%>.ParentControlID = "<%=Me.ClientID%>";
