...
<ComponentArt:Dialog
  ...
  <Content>
    ...
    <div class="ts">
      <div class="ts-l"></div>
      <div class="ts-m">
        <a href="javascript:void(0);" class="tab-sel" onclick="toggle_dialog_tab(this,<%=FindDialog.ClientID%>,0,'tab-sel','tab');this.blur();" title="Find"><img src="<%=Me.Attributes("SkinFolderLocation")%>/images/_blank.png" width="16" height="16" alt="Find icon" class="icon find" /><span class="image">Find</span></a>
        <a href="javascript:void(0);" class="tab" onclick="toggle_dialog_tab(this,<%=FindDialog.ClientID%>,1,'tab-sel','tab');this.blur();" title="Replace"><img src="<%=Me.Attributes("SkinFolderLocation")%>/images/_blank.png" width="16" height="16" alt="Replace icon" class="icon replace" /><span class="image">Replace</span></a>
      </div>
      <div class="ts-r"></div>
    </div>
      ...
      <div class="con-m find">
        ...
        <ComponentArt:MultiPage ID="FindPages" RunAt="server">
          <ComponentArt:PageView ID="PageView1" RunAt="server">
            <div class="fields">
              <div class="row top"><span class="label">Find what:</span><input id="<%=Me.ClientID%>_find_text" type="text" class="find-text" NAME="find_text"/></div>
              ...
              <div class="row widgets"><a id="<%=Me.ClientID%>_find_matchwholeword" class="chk find-match-word" href="javascript:void(0);" onclick="toggle_checkbox(this,'chk-sel','chk');this.blur();return false;">Match whole word only</a></div>
              <div class="row widgets"><a id="<%=Me.ClientID%>_find_matchcase" class="chk find-match-case" href="javascript:void(0);" onclick="toggle_checkbox(this,'chk-sel','chk');this.blur();return false;">Match case</a></div>
            </div>
          ...
          <div class="fields">
            <div class="row top"><span class="label">Find what:</span><input id="<%=Me.ClientID%>_replace_text" type="text" class="replace-find-text" NAME="replace_text"/></div>
            <div class="row"><span class="label">Replace with:</span><input id="<%=Me.ClientID%>_replace_replacetext" type="text" class="replace-text" NAME="replace_replacetext"/></div>
            ...
            <div class="row widgets"><a id="<%=Me.ClientID%>_replace_matchwholeword" class="chk replace-match-word" href="javascript:void(0);" onclick="toggle_checkbox(this,'chk-sel','chk');this.blur();return false;">Match whole word only</a></div>
            <div class="row widgets"><a id="<%=Me.ClientID%>_replace_matchcase" class="chk replace-match-case" href="javascript:void(0);" onclick="toggle_checkbox(this,'chk-sel','chk');this.blur();return false;">Match case</a></div>
          </div>
