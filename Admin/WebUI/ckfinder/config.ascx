...
<script runat="server">
	...
	public override void SetConfig()
	{
        ...
        Thumbnails.Url = BaseUrl + "TT/";
		if ( BaseDir != "" ) {
            Thumbnails.Dir = BaseDir + "TT/";
		}
	    ...
	    ResourceType type;
	    var ckfinder = new CKFinder.Settings.ResourceTypeManager();
        type = ResourceType.Add("TT");
		type.Url = BaseUrl + "TT/";
        type.Dir = BaseDir == "" ? "" : BaseDir + "TT/";
		type.MaxSize = 0;
