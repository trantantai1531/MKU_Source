<%@ Control Language="VB" AutoEventWireup="false" CodeFile="Dialog_Content_Table_Of_Contents.ascx.vb" Inherits="UI_Control_Sys_Common_Dialog_Content_Table_Of_Contents" %>
...
.iFrameCss
{
  ...
  <script type="text/javascript">    
    function dialogshow(dialog) {
        document.getElementById('dialogtitle').innerHTML = Dialog_Content_Table_Of_Contents.get_title();				
    }    
...
<ComponentArt:Dialog IFrameCssClass="iFrameCss"  ContentUrl="## Parent.ContentUrl ##"  ContentCssClass="contentCss" FooterCssClass="footerCss" HeaderCssClass="headerCss" CssClass="contentCss" Value="" Alignment="TopLeft"  ID="Dialog_Content_Table_Of_Contents" IFrameScrolling="yes" runat="server" Height="0" Width="0" Offsetx="0" PreloadContentUrl="true" AlignmentElement="TreeViewCollection_Table_Of_Contents">
  <ClientEvents>
    <OnShow EventHandler="dialogshow" />    
    <OnClose EventHandler="dialogclose" />                    
  </ClientEvents>
    <Header>
        <table cellpadding="0" cellspacing="0" id="tableheader" width="100%"  onmousedown="Dialog_Content_Table_Of_Contents.StartDrag(event);">
            <tr>
                ...
                <td style="cursor:default;background-color:#d5d5d5;" width="7">
                    <img style="display:block;cursor:pointer;" src="Images/ComponentArt/Dialog/images/btn_close2.gif" onclick="Dialog_Content_Table_Of_Contents.Close('Close click');"/>
                </td>
            </tr>
        </table>
    </Header>
