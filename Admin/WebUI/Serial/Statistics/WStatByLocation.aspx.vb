...
' Method works : Statistic allow location 
...
#End Region
        ...
        Sub EventStatic()
            ...
            Try
                ...
                Call objBPeriodicalCollection.StatByLocation()
                ' Write error
                ...
                If Not arrData Is Nothing Then
                    If UBound(arrData) > -1 Then
                        ...
                        strOutput = Replace(strOutput, "xLabel", "Location")
