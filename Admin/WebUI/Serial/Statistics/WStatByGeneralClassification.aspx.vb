' Class: WStatByGeneralClassification
' Puspose: create statistiuc GeneralClassification
' Creator: Oanhtn
...
' Method works : Statistic allow classification
...
Namespace eMicLibAdmin.WebUI.Serial
    Partial Class WStatByGeneralClassification
        Inherits clsWBase
...
#End Region
        ...
        Private Sub Page_Load(ByVal sender As System.Object, ByVal e As System.EventArgs) Handles MyBase.Load
            ...
            Call Initialize()
            Call BindScript()
            'Statistic allow genarate classifition
            Call EventStatic()
        End Sub
        ...
        Sub EventStatic()
            ...
            Try
                ...
                ' Static by genarate classification
                Call objBPeriodicalCollection.StatByGenClassification()
                ' Write error
                ...
                If Not arrData Is Nothing Then
                    If UBound(arrData) > -1 Then
                        ...
                        strOutput = Replace(strOutput, "xLabel", "GenClassification")
