' Class: WStatByCategory
' Puspose: Statistic Report by category
' Creator: Oanhtn
...
' Method works : Statistic allow category
            ...
            Try
                ...
                If Not arrData Is Nothing Then
                    If UBound(arrData) > -1 Then
                        ...
                        strOutput = Replace(strOutput, "xLabel", "Catagory")
