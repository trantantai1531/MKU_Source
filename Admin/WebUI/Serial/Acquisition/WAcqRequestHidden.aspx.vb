...
#End Region
        ...
        Private Sub BindJScript()
            ...
            Page.RegisterClientScriptBlock("CheckExistItem", "<script language = 'Javascript' src = '../js/Acquisition/WAcqRequestHidden.js'></script>")
        End Sub
        ...
        Private Sub LoadData()
            ...
            strJS = strJS & strLanguage & "','"
            strJS = strJS & strCountry & "');"
            strJS = strJS & "</script>"
