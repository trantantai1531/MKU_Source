...
(function pullPagePullImplementation($) {
  ...
  var pullDownGeneratedCount = 0,
      ...
      listSelector = "div.ui-responsive-panel ul.ui-listview",
  ...
  $(document).delegate("div.ui-responsive-panel", "pageinit", 
...
(function shortPullPagePullImplementation($) { 
  ...
  var pullDownGeneratedCount = 0,
    pullUpGeneratedCount = 0,
    listSelector = "div.short-ui-responsive-panel ul.ui-listview",
    lastItemSelector = listSelector + " > li:last-child";
  ...
  $(document).delegate("div.short-ui-responsive-panel", "pageinit", 
