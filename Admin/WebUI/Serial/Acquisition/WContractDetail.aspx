<%@ Page Language="vb" AutoEventWireup="false" Inherits="eMicLibAdmin.WebUI.Serial.WContractDetail" CodeFile="WContractDetail.aspx.vb" CodeFileBaseClass="eMicLibAdmin.WebUI.clsWBase" %>
			...
			<TABLE id="Table1" cellSpacing="1" cellPadding="3" width="100%" border="0">
				...
				<TR>
					...
					<TD width="18%">
						...
						<asp:dropdownlist id="ddlCurrency" runat="server" Width="51px" Enabled="False"></asp:dropdownlist></TD>
				</TR>
				<TR>
				...
				<TR>
					...
					<TD>
						...
						<asp:textbox id="txbFilledDate" runat="server" Width="80px" ReadOnly="True"></asp:textbox>&nbsp;
					</TD>
					<TD align="right">
				...
				<TR>
					<TD colSpan="4" Class="lbGroupTitle">
						<asp:label id="lblItemInfor" runat="server" CssClass="main-group-form" Width="100%">Thông tin ấn phẩm</asp:label></TD>
				</TR>
				<TR>
				...
				<TR>
					<TD colSpan="4" Class="lbGroupTitle">
						<asp:label id="lblPoStatus" runat="server" CssClass="main-group-form" Width="100%">Nhật ký trạng thái</asp:label></TD>
				</TR>
				<TR>
					<TD colSpan="4">
