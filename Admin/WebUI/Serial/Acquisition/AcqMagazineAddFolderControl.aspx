<%@ Page Language="VB" AutoEventWireup="false" CodeFile="AcqMagazineAddFolderControl.aspx.vb" Inherits="eMicLibAdmin.WebUI.Serial.Pages_AcqMagazineAddFolderControl" %>
      ...
      <script type="text/javascript">
        <!--
          ...
          function OnSubmit(key) {
              parent.mainaddfolder.CheckSubmit(key);
              return;
        }
       //-->
     </script>     
...
<body  class="bgbody" style="margin-top:0;margin-left:0;margin-right:0;margin-bottom:0">
        ...
        <ContentTemplate>   
            ...
            <tr>
              <td valign="top" style="width:100%;" align="center">   
                    ...
                    <Items>
                      <ComponentArt:ToolBarItem runat="server" Text="Nhập"  Value="addfolder"    ImageUrl="addfieldUpdate.png" />
    ...
    <div style="display:none">
        <span  id="span_Toolbar_item0" runat="server">Nhập</span>
