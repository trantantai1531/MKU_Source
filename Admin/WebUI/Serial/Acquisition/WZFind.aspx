<%@ Page Language="vb" AutoEventWireup="false" Inherits="eMicLibAdmin.WebUI.Serial.WZFind" EnableViewStateMAC="False" EnableViewState="false" CodeFile="WZFind.aspx.vb" CodeFileBaseClass="eMicLibAdmin.WebUI.clsWBase" %>
<!DOCTYPE HTML PUBLIC "-//W3C//DTD HTML 4.0 Transitional//EN">
<HTML>
	<HEAD>
		<title>Tìm thông tin qua Z3950</title>
	...
	<body leftMargin="0" topMargin="0">
		<form id="Form1" method="post" runat="server">
			<table cellSpacing="0" cellPadding="2" width="100%">
				...
				<TR>
					<TD align="center">
						<INPUT type="hidden" runat="server" id="txtHidTitle" name="txtHidTitle" style="WIDTH: 78px; HEIGHT: 22px"
							size="7"> <INPUT type="hidden" runat="server" id="txtHidAuthor" name="txtHidAuthor" style="WIDTH: 85px; HEIGHT: 22px"
							size="8"> <INPUT type="hidden" runat="server" id="txtHidISBN" name="txtHidISBN" style="WIDTH: 73px; HEIGHT: 22px"
							size="6"> <INPUT type="hidden" runat="server" id="txtHidISSN" name="txtHidISSN" style="WIDTH: 69px; HEIGHT: 22px"
							size="6"> <INPUT type="hidden" runat="server" id="txtHidPublisher" name="txtHidPublisher" style="WIDTH: 88px; HEIGHT: 22px"
							size="9"> <INPUT type="hidden" runat="server" id="txtHidPublishYear" name="txtHidPublishYear" style="WIDTH: 88px; HEIGHT: 22px"
							size="9"> <INPUT type="hidden" runat="server" id="txtHidPublishOrder" name="txtHidPublishOrder" style="WIDTH: 75px; HEIGHT: 22px"
							size="7">
