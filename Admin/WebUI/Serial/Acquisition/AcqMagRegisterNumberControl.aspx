<%@ Page Language="VB" AutoEventWireup="false" CodeFile="AcqMagRegisterNumberControl.aspx.vb" Inherits="eMicLibAdmin.WebUI.Serial.Pages_AcqMagRegisterNumberControl" %>
    ...
    <script type="text/javascript">
        <!--
          ...
          function OnSubmit(key) {
              parent.maincontentMagazine.CheckSubmit(key);              
              return;
          }
...
<body  class="bgbody" style="margin-top:0;margin-left:0;margin-right:0;margin-bottom:0">
        ...
        <ContentTemplate>   
            ...
            <tr>             
              <td valign="top" style="width:100%;" align="center">   
                    ...
                    <Items>                      
                      <ComponentArt:ToolBarItem ID="ToolBarItem2" runat="server" Text="Cập nhật"    Value="update"    ImageUrl="Update.png" />
    ...
    <div style="display:none">                
        <span  id="span_update" runat="server">Cập nhập</span>
