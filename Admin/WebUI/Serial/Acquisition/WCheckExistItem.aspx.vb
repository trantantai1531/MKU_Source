                ...
                If tblItem.Rows.Count > 0 Then
                    ...
                    For intCount = 0 To UBound(arrItemID)
                        ...
                        If Len(strISBD) > 5 Then
                            ...
                            "<BR>&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;" & _
                            "<A class=""lbLinkFunction"" HREF=""javascript:opener.top.main.Hiddenbase.location.href = 'WAcqRequestHidden.aspx?ID=" & arrItemID(intCount) & "' ; self.close();"">" & ddlLabel.Items(2).Text & " </A>"))
                        Else
                            tblCells.Controls.Add(New LiteralControl(""))
                        End If
