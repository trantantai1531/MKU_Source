<%@ Page Language="vb" AutoEventWireup="false" Inherits="eMicLibAdmin.WebUI.Serial.WItemDetails" CodeFile="WItemDetails.aspx.vb" CodeFileBaseClass="eMicLibAdmin.WebUI.clsWBase" %>
		...
		<form id="Form1" method="post" runat="server">
			<TABLE cellSpacing="0" cellPadding="2" width="100%" border="0">
				<TR class="lbPageTitle">
					<TD><asp:label id="lblMainTitle" Runat="server" cssclass="lbPageTitle main-group-form">Thông tin thư mục của ấn phẩm</asp:label>
					</TD>
				</TR>
				<TR>
