...
function EncryptionTags(){	
	...
	document.forms[0].txtHeader.value=replaceSubstring(document.forms[0].txtHeader.value,'>','&gt;');
	//Collum
	document.forms[0].hidCollum.value=replaceSubstring(document.forms[0].hidCollum.value,'<','&lt;');
	document.forms[0].hidCollum.value=replaceSubstring(document.forms[0].hidCollum.value,'>','&gt;');
	//Align
	document.forms[0].txtAlign.value=replaceSubstring(document.forms[0].txtAlign.value,'<','&lt;');
	document.forms[0].txtAlign.value=replaceSubstring(document.forms[0].txtAlign.value,'>','&gt;');
	//Format
	document.forms[0].txtFormat.value=replaceSubstring(document.forms[0].txtFormat.value,'<','&lt;');
	document.forms[0].txtFormat.value=replaceSubstring(document.forms[0].txtFormat.value,'>','&gt;');
	//Footer
...
var strCollum='';	
	...
	if (strCollum.length>0)	document.forms[0].hidCollum.value=strCollum.substring(0,(strCollum.length)-3);
	else document.forms[0].hidCollum.value='';	
}
...
function Preview(){
	...
	parent.Workform.document.forms[0].action='WPreviewTemplate.aspx';
	...
	DecryptionTags();
	parent.Workform.document.forms[0].action='WClaimTemplateManagement.aspx';
