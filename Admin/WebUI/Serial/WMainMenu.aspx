<%@ Page Language="vb" AutoEventWireup="false" Inherits="eMicLibAdmin.WebUI.Serial.WMainMenu" CodeFile="WMainMenu.aspx.vb" CodeFileBaseClass="eMicLibAdmin.WebUI.clsWBase" %>
	...
	<body topmargin="0" leftmargin="0">
		<form id="Form1" method="post" runat="server">
			<table border="0" width="100%" cellspacing="0" cellpadding="0">
				<tr>
					<td width="89" onclick="javascript:MenuChange();OpenQuickView()"><asp:Image ImageUrl="../Images/dinh_ky.gif" id="imgModule" runat="server"></asp:Image></td>
					<td width="6" background="../Images/002_vach_01.gif"></td>
					<td style="display:none;" width="6" id="menu1a" background="../Images/002_002.gif"></td>
					<td style="display:none;" id="menu1" background="../Images/002_bg.gif" onmouseover="MenuHover(1)" onclick="MenuChange();OpenArticle();MenuClick(1);"
						onmouseout="MenuOut(1);">
						<p align="center">
							<asp:hyperlink CssClass="lbFunctionMenu" id="lnkArticle" runat="server" NavigateUrl="#">			
								Mục lục
							</asp:hyperlink>
						</p>
					</td>
					<td width="12" id="menu2a" background="../Images/002_003.gif"></td>
					<td id="menu2" background="../Images/002_bg.gif" onmouseover="MenuHover(2)" onclick="MenuChange();OpenAcquisition();MenuClick(2);"
						onmouseout="MenuOut(2);">
						<p align="center">
							<asp:hyperlink CssClass="lbFunctionMenu" id="lnkAcquisition" runat="server" NavigateUrl="#">
								Bổ sung
							</asp:hyperlink>
						</p>
					</td>
					<td style="display:none;" width="12" id="menu3a" background="../Images/002_003.gif"></td>
					<td style="display:none;" id="menu3" background="../Images/002_bg.gif" onmouseover="MenuHover(3)" onclick="MenuChange();OpenClaim();MenuClick(3);"
						onmouseout="MenuOut(3);">
						<p align="center">
							<asp:hyperlink CssClass="lbFunctionMenu" id="lnkClaim" runat="server" NavigateUrl="#">
								Khiếu nại
							</asp:hyperlink>
						</p>
					</td>
					<td width="12" id="menu4a" background="../Images/002_003.gif"></td>
					<td id="menu4" background="../Images/002_bg.gif" onmouseover="MenuHover(4)" onclick="MenuChange();OpenStatistic();MenuClick(4);"
					...
					<td id="menu5" background="../Images/002_bg.gif" onmouseover="MenuHover(5)" onclick="MenuChange();OpenSearch();MenuClick(5);"
						onmouseout="MenuOut(5);">
						<p align="center">
							<asp:hyperlink CssClass="lbFunctionMenu" id="lnkSearch" runat="server" NavigateUrl="#">
								Tìm kiếm
							</asp:hyperlink>
						</p>
					</td>
