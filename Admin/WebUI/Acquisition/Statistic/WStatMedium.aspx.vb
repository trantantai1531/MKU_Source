' Class: WStatMedium
' Puspose: Create statistic by medium
' Creator: Sondp
' CreatedDate: 01/04/2005
' Modification History:
'   - 13/04/2005 by Oanhtn
...
#End Region
        ...
        Private Sub GenChart()
            ...
            objBS.StatMedium(lblDAPTotal.Text, lblBAPTotal.Text)
            ...
            Else
                ...
                objBCC.Makebarchart(objData, objLabel, strVtitle, strHtitle, 45, strImg, "WStatMedium.aspx")
