...
Namespace eMicLibAdmin.WebUI.Acquisition
    Partial Class WStatClassItemIDSchema
        Inherits clsWBase
...
#End Region
        ...
        Private Sub BindScript()
            ...
            Page.RegisterClientScriptBlock("WStatClassItemIDSchemaJs", "<script language='javascript' src='../Js/Statistic/WStatClassItemIDSchema.js'></script>")
        ...
        Private Sub BindData()
            ...
            Catch ex As Exception
                Call WriteErrorMssg(ddlLabel.Items(1).Text, objBCDBS.ErrorMsg, ddlLabel.Items(2).Text, objBCDBS.ErrorCode)
            End Try
        End Sub
        ...
        Private Sub GenChart(ByVal boolRoot As Boolean)
            ...
            strHTitle = ddlLabel.Items(4).Text & strClassTab
            strTitle = ddlLabel.Items(5).Text & strClassTab
            ...
            Else ' Gen Branch Chart
                Try
                    ...
                    End If
                Catch ex As Exception
                    Call WriteErrorMssg(ddlLabel.Items(1).Text, ex.Message.Trim, ddlLabel.Items(2).Text, 0)
                End Try
            End If
        End Sub
