<%@ Page Language="VB" AutoEventWireup="false" CodeFile="WStatViewItem.aspx.vb" Inherits="eMicLibAdmin.WebUI.Acquisition.WStatViewItem" %>

<!DOCTYPE HTML PUBLIC "-//W3C//DTD HTML 4.0 Transitional//EN">
<HTML>
	<HEAD>
		<title>WStatViewItem</title>
    ...
    <body leftmargin="0" topmargin="0" onload="GenURLImg(9)" rightmargin="0">
        <form id="Form1" method="post" runat="server">
            <div id="divBody">
                <asp:Label ID="lblTitle" CssClass="main-head-form" Width="100%" runat="server">Thống kê lượt xem tài liệu điện tử</asp:Label>
            ...
            <asp:DropDownList ID="ddlLabelValue" runat="server" Visible="False" Height="0" Width="0">
				...
				<asp:ListItem Value="5">Số lượng TLĐT xem</asp:ListItem>
				<asp:ListItem Value="6">Mã bạn đọc</asp:ListItem>
            </asp:DropDownList>
            <input id="hidHave" runat="server" type="hidden" value="1" name="hidHave">
            <asp:HiddenField ID="hidTitleChart" runat="server" Value="Biểu đồ thống kê lượt xem tài liệu điện tử" />
            <asp:DropDownList ID="ddlLog" Runat="server" Visible="False">
				<asp:ListItem Value="MainLog">Thống kê lượt xem tài liệu điện tử</asp:ListItem>
