<%@ Page Language="VB" AutoEventWireup="false" CodeFile="WStatHoldingTotal.aspx.vb" Inherits="eMicLibAdmin.WebUI.Acquisition.WStatHoldingTotal" %>
...
<body topmargin="0" leftmargin="0">
    <form id="form1" runat="server">
         <div id="divBody">
            <div class="main-body">
                <h1 class="main-head-form">Báo cáo tổng hợp tài liệu truyền thống</h1>
        ...
        <asp:DropDownList ID="ddlLabelValue" runat="server" Visible="False" Height="0" Width="0">
			...
			<asp:ListItem Value="6">Mã bạn đọc</asp:ListItem>
             ...
             <asp:Label runat="server" ID="lblTitle" Visible="false">Báo cáo tổng hợp (Theo bản ấn phẩm)</asp:Label>
