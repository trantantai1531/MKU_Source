...
Namespace eMicLibAdmin.WebUI.Acquisition
    Partial Class WStatDownloadItem
        Inherits clsWBase
        ...
        Private Sub BindStatic()
            ...
            If (rdNgay.Checked) Then
                ...
                If rdStaticItemFile.Checked Then
                    objBStatic.GetItemDownLoadByDay(intThang, intNam, 0)
                End If

                If rdStaticPatron.Checked Then
                    objBStatic.GetItemDownLoadByDay(intThang, intNam, 1)
                End If
            End If
            ...
            If (rdTuan.Checked) Then
                ...
                If rdStaticItemFile.Checked Then
                    objBStatic.GetItemDownLoadByWeek(intWeekFrom, intWeekTo, intYear, 0)
                End If

                If rdStaticPatron.Checked Then
                    objBStatic.GetItemDownLoadByWeek(intWeekFrom, intWeekTo, intYear, 1)
                End If
            End If
            ...
            If (rdThang.Checked) Then
                ...
                If rdStaticItemFile.Checked Then
                    objBStatic.GetItemDownLoadByMonth(intYear, 0)
                End If

                If rdStaticPatron.Checked Then
                    objBStatic.GetItemDownLoadByMonth(intYear, 1)
                End If
            ...
            If (rdNam.Checked) Then
                ...
                If rdStaticItemFile.Checked Then
                    objBStatic.GetItemDownLoadByYear(intYearFrom, intYearTo, 0)
                End If

                If rdStaticPatron.Checked Then
                    objBStatic.GetItemDownLoadByYear(intYearFrom, intYearTo, 1)
                End If
            End If
            ...
            If (rdOther.Checked) Then
                ...
                If rdStaticItemFile.Checked Then
                    objBStatic.GetItemDownLoad(strDateFrom, strDateTo, 0)
                End If

                If rdStaticPatron.Checked Then
                    objBStatic.GetItemDownLoad(strDateFrom, strDateTo, 1)
                End If
            End If
