<%@ Page Language="VB" AutoEventWireup="false" CodeFile="WStatTimes.aspx.vb" Inherits="eMicLibAdmin.WebUI.Acquisition.WStatTimes" %>
...
<HTML>
	...
	<body bgcolor="white" topmargin="0" leftmargin="0" rightmargin="0" bottommargin="0" onload="GenURLImg(7)">
		<form id="Form1" method="post" runat="server">
                ...
                <div class="two-column-form">
                    <div class="row-detail">
                        <table id="StatDay" runat="server" border="0" align="center" width="100%" bgcolor="white">
				            <tr>
					            <td colspan="2">
						            <asp:Label id="lblDAP" runat="server" Width="100%" CssClass="lbGroupTitle"></asp:Label>
					            </td>
				            </tr>
				            <tr>
				            ...
				            <tr>
					            <td colspan="2">
						            <asp:Label id="lblBAP" runat="server" Width="100%" CssClass="lbGroupTitle"></asp:Label>
					            </td>
				            </tr>
				            <tr>
				            ...
				            <tr>
					            <td colspan="2">
						            <asp:Label id="lblMoney" runat="server" Width="100%" CssClass="lbGroupTitle"></asp:Label>
					            </td>
				            </tr>
				            <tr>
                    ...
                    <div class="row-detail">
                        <asp:GridView ID="dtgResult" runat="server" Width="100%" HeaderStyle-HorizontalAlign="Center" ItemStyle-CssClass="lbGridItem" HeaderStyle-CssClass="lbGridHeader" AlternatingItemStyle-CssClass="lbGridAlterCell" AutoGenerateColumns="False" AllowPaging="True" PageSize="20">
                            <Columns>
                                ...
                                <asp:BoundField HeaderText="Thời gian" ItemStyle-HorizontalAlign="Center" DataField="Times"/>
            ...
            <asp:label id="lblDAPHTitle" Visible="False" Runat="server"></asp:label>
            <asp:label id="lblDAPVTitle" Visible="False" Runat="server">Số đầu ấn phẩm</asp:label>
            <asp:label id="lblDAPTitle" Visible="False" Runat="server">Tỉ lệ % đầu ấn phẩm theo các ngày</asp:label>
            <asp:label id="lblBAPTotal" Visible="False" Runat="server">Tổng số bản ấn phẩm</asp:label>
            <asp:label id="lblBAPHTitle" Visible="False" Runat="server"></asp:label>
            <asp:label id="lblBAPVTitle" Visible="False" Runat="server">Số bản ấn phẩm</asp:label>
            <asp:label id="lblBAPTitle" Visible="False" Runat="server">Tỉ lệ % bản ấn phẩm theo các ngày</asp:label>
			<asp:Label ID="lblVMoney" Runat="server" Visible="False">Mức chi phí đ/v: 1000vnđ</asp:Label>
			<asp:Label ID="lblHMoney" Runat="server" Visible="False"></asp:Label>
			<asp:Label ID="lblTMoney" Runat="server" Visible="False">Tỉ lệ % mức chi phí giữa các ngày </asp:Label>
			<asp:Label ID="lblDateFrom" Runat="server" Visible="False"> Từ ngày </asp:Label>
			<asp:Label ID="lblDateTo" Runat="server" Visible="False"> Đến ngày </asp:Label>
            ...
            <asp:DropDownList runat="server" ID="ddlLabelHeaderTable" Visible="False" Height="0" Width="0">
                ...
                <asp:ListItem Value="5">Thời gian</asp:ListItem>
