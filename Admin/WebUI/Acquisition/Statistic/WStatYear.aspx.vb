' Class: WStatYear
' Puspose: Create statistic by acquired year
' Creator: Sondp
...
#End Region
        ...
        Private Sub GenChart()
            ...
            Try
                If Request.QueryString("xLabel") & "" = "" Then ' Statistic all years                    
                    ...
                    objBS.StatYear(lblDAPTotal.Text, lblBAPTotal.Text, lblCAPToal.Text, lblInYear.Text, If(String.IsNullOrEmpty(txtYearStart.Text), DateTime.Now.Year - 4, CType(txtYearStart.Text, Integer)), If(String.IsNullOrEmpty(txtYearEnd.Text), DateTime.Now.Year, CType(txtYearEnd.Text, Integer)))
                    ...
                    Else
                        ...
                        objBCC.Makebarchart(objData, objLabel, strVtitle, strHtitle, 45, strImg, "WStatYear.aspx")
                        ...
                        objBCC.Makebarchart(objDataNext, objLabel, strVtitle, strHtitle, 45, strImg, "WStatYear.aspx")
                        ...
                        objBCC.Makebarchart(objDataMoney, objLabel, strVtitle, strHtitle, 45, strImg, "WStatYear.aspx")
        ...
        Private Sub BindData()
            ...
            objBS.LibID = clsSession.GlbSite
            Dim tblData As DataTable = objBS.StatYearOtherDetail(intYearStart, intYearEnd)
