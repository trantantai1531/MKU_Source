...
function CheckValidData(strFlage,strTemplateMsg){
	if(document.forms[0].ddlTemplate.options[document.forms[0].ddlTemplate.options.selectedIndex].value==0){
		alert(strTemplateMsg);
		document.forms[0].ddlTemplate.focus();
		return(false);		
	}
	if(document.forms[0].hdPOID.value==0){
		return(false);
	}
	self.location.href='WSendPOSeperated.aspx?Flage=' + strFlage + '&POID=' + document.forms[0].hdPOID.value + '&TemplateID=' + document.forms[0].ddlTemplate.options[document.forms[0].ddlTemplate.options.selectedIndex].value + '&Top=' + document.forms[0].ddlUbound.options[document.forms[0].ddlUbound.options.selectedIndex].value;
	return(true);
}
// Preview function
function Preview(action){
	...
	document.forms[0].action='WSendPOSeperatedActionResult.aspx?action=' + action;
	document.forms[0].target='PreviewFormWin';
	document.forms[0].submit();			
	document.forms[0].action='WSendPOSeperatedAction.aspx';
