...
function TransferData() {
    parent.Display.location.href = 'WStatTimes.aspx?strDateFrom=' + document.forms[0].txtDateFrom.value + '&strDateTo=' + document.forms[0].txtDateTo.value;
    return (false);
}

// Export data
function TransferDataExport() {
    parent.Display.location.href = 'WStatTimes.aspx?export=true&strDateFrom=' + document.forms[0].txtDateFrom.value + '&strDateTo=' + document.forms[0].txtDateTo.value;
    return (false);
}