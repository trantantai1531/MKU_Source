...
function ChangeTemplate(){
	...
	top.main.hiddenbase.location.href='WBarcodeTemplateHidden.aspx?TemplateID='+ document.forms[0].ddlTemplate.options[document.forms[0].ddlTemplate.options.selectedIndex].value;	
	return false;
}
...
function CheckValidData(strEmtyTitle){
    EncryptionTags('document.forms[0].txtContent');
    console.log(document.forms[0].txtTitle.value.trim());
	if (document.forms[0].txtTitle.value.trim() == '') {
		alert(strEmtyTitle);
		document.forms[0].txtTitle.focus();
	    document.forms[0].txtTitle.value = "";
		return false;
...
function PreviewBarcodeTemplate(){	
	...
	document.forms[0].action='WBarcodeTemplatePreview.aspx';
	document.forms[0].target='PreviewTemplateWin';
	document.forms[0].submit();			
	document.forms[0].action='WBarcodeTemplateEdit.aspx';
