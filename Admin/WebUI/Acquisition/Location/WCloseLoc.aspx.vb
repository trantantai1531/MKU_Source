...
#Region " Web Form Designer Generated Code "
        ...
        End Sub
        Protected WithEvents lblNoLocation As System.Web.UI.WebControls.Label
...
#End Region
        ...
        Private Sub CheckFormPermission()
            If Not CheckPemission(114) Then
                btnCloseLoc.Enabled = False
            End If
        End Sub
        ...
        Private Sub BindJS()
            ...
            btnCloseLoc.Attributes.Add("onClick", strJSCheck & " else " & strJSConfirm)
        End Sub
        ...
        Private Sub BindData()
            ...
            If ddlLibrary.Items.Count > 0 Then
                ...
                If Not blnNoInfo Then
                    ...
                    btnCloseLoc.Visible = True
                Else
                    dtgLocation.Visible = False
                    btnCloseLoc.Visible = False
        ...
        ' btnCloseLoc_Click event
        Private Sub btnCloseLoc_Click(ByVal sender As System.Object, ByVal e As System.EventArgs) Handles btnCloseLoc.Click
            ...
            If strIDs <> "" Then
                ...
                Call WriteErrorMssg(ddlLabelNote.Items(4).Text, objBLocation.ErrorMsg, ddlLabelNote.Items(5).Text, objBLocation.ErrorCode)
                If objBLocation.ErrorMsg = "" Then
                    Call WriteLog(92, ddlLabelNote.Items(6).Text & " " & ddlLibrary.SelectedItem.Text & " -- " & strNameLoc, Request.ServerVariables("SCRIPT_NAME"), Request.ServerVariables("REMOTE_ADDR"), clsSession.GlbUserFullName)
