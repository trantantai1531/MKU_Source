<%@ Page Language="vb" AutoEventWireup="false" Inherits="eMicLibAdmin.WebUI.Acquisition.WPODetail" CodeFile="WPODetailByID.aspx.vb" CodeFileBaseClass="eMicLibAdmin.WebUI.clsWBase" %>
		...
		<form id="Form1" method="post" runat="server">
			<TABLE id="Table1" cellSpacing="1" cellPadding="3" width="100%" border="0">
				...
				<TR>
					...
					<TD width="18%">
						<asp:textbox id="txbTotalAmount" runat="server" Width="165px" ReadOnly="True">0</asp:textbox>
				...
				<TR>
					...
					<TD width="20%">
						<asp:textbox id="txbFixedRate" runat="server" Width="165px" ReadOnly="True">1</asp:textbox></TD>
				</TR>
				<TR>
					<TD align="right" width="15%">
					...
					<TD width="20%">
						<asp:textbox id="txbPrepaidAmount" runat="server" Width="165px" ReadOnly="True">0</asp:textbox></TD>
				</TR>
				<TR>
					<TD align="right" width="15%">
						<asp:label id="lblValidDate" runat="server">Ngà<U>y</U> bắt đầu:</asp:label></TD>
					<TD>
						<asp:textbox id="txbValidDate" runat="server" Width="165px" ReadOnly="True"></asp:textbox>&nbsp;
						<asp:label id="Label2" runat="server">Ngày <U>k</U>ết thúc:</asp:label>
						<asp:textbox id="txbFilledDate" runat="server" Width="165px" ReadOnly="False"></asp:textbox>&nbsp;
					</TD>
					<TD align="right">
						<asp:label id="lblDiscount" runat="server">Giả<U>m</U> giá:</asp:label></TD>
					<TD width="20%">
						<asp:textbox id="txbDiscount" runat="server" Width="165px" ReadOnly="True">0</asp:textbox></TD>
				</TR>
				<TR>
					<TD align="right" width="15%">
					...
					<TD width="20%">
						<asp:textbox id="txbPlanAmount" runat="server" Width="165px" ReadOnly="True">0</asp:textbox></TD>
				</TR>
				<TR>
					<TD align="right" width="15%">
					...
					<TD width="20%">
						<asp:textbox id="txbRealAmount" runat="server" Width="165px" ReadOnly="True">0</asp:textbox></TD>
				</TR>
				<TR>
				...
				<TR>
					<TD colSpan="4">
						<asp:datagrid id="dtgAccount" runat="server" Width="100%" AutoGenerateColumns="False" HeaderStyle-HorizontalAlign="Center">
							<Columns>
								<asp:BoundColumn DataField="AmountTmp" HeaderText="Số tiền" ItemStyle-HorizontalAlign="Right" ItemStyle-Width="8%"></asp:BoundColumn>
								<asp:BoundColumn DataField="ExchangeRateTmp" HeaderText="Tỷ giá" ItemStyle-HorizontalAlign="Right" ItemStyle-Width="6%"></asp:BoundColumn>
