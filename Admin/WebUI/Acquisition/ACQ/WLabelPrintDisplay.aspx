<%@ Page Language="vb" AutoEventWireup="false" Inherits="eMicLibAdmin.WebUI.Acquisition.WLabelPrintDisplay" CodeFile="WLabelPrintDisplay.aspx.vb" CodeFileBaseClass="eMicLibAdmin.WebUI.clsWBase" %>
...
<HTML>
	<HEAD>
        ...
        <style type="text/css">
            @font-face {
                font-family:'DejaVu';
                src:url('../../Resources/fonts/DejaVuSerif-Bold.ttf');
            }
            #lblDisplay
            {
                font-family:'DejaVu';
