<%@ Page Language="vb" AutoEventWireup="false" Inherits="eMicLibAdmin.WebUI.Circulation.WReservations" CodeFile="WReservations.aspx.vb" CodeFileBaseClass="eMicLibAdmin.WebUI.clsWBase" %>
			...
			<TABLE id="Table1" cellSpacing="1" cellPadding="1" width="100%" border="0">
				<tr>
					<td colSpan="3" align="left">
						<asp:Label ID="lblTitle" Runat="server" CssClass="main-group-form" Width="100%">Yêu cầu đặt mượn</asp:Label>
					</td>
				</tr>
				<!--
				<TR>
					<TD align="left">
						<asp:label id="lblRemark" Runat="server">Chế độ tự động thông báo đang</asp:label>
						<asp:label id="lblOn" Runat="server">bật</asp:label>
						<asp:label id="lblOff" Runat="server">tắt</asp:label></TD>
					<TD colSpan="2" align="left">
						<asp:HyperLink id="lnkOff" runat="server">Tắt</asp:HyperLink>
						<asp:HyperLink id="lnkOn" runat="server">Bật</asp:HyperLink>
						<asp:label id="lblAfter" Visible="False" runat="server"> sau mỗi </asp:label>
						<asp:TextBox id="txtTime" runat="server" Width="31px" Visible="false">120</asp:TextBox>
						<asp:label id="lblTime" runat="server" Visible="false"> giây</asp:label>
					</TD>
				</TR>
				-->
				<TR>
						...
						<asp:datagrid id="dgrOrderResult" runat="server" Width="100%" AutoGenerateColumns="False">
							<Columns>
								...
								<asp:TemplateColumn HeaderText="STT" ItemStyle-VerticalAlign="Top" ItemStyle-HorizontalAlign="Center">
									...
									<ItemTemplate>
										<asp:label ID="lblSTT" text='<%# DataBinder.Eval(Container.dataItem,"CRR_ID")%>' Runat="server">
										</asp:label>
									</ItemTemplate>
								</asp:TemplateColumn>
								<asp:TemplateColumn HeaderText="Tài liệu đặt mựơn">
									<ItemTemplate>
										<asp:label ID="lblItemTitle" text='<%# DataBinder.Eval(Container.dataItem,"MainItem")%>' Runat="server">
										</asp:label>
									</ItemTemplate>
								</asp:TemplateColumn>
								...
								<asp:TemplateColumn Visible="False">
									...
									<ItemTemplate>
										<asp:label ID="lblHidden" text='<%# DataBinder.Eval(Container.dataItem,"Crr_ID")%>' Runat="server" Visible="False">
										</asp:label>
									</ItemTemplate>
								</asp:TemplateColumn>
                ...
                <tr>
                    <asp:DataGrid CssClass="table-control" ID="dtgResult" runat="server" Width="100%" AllowSorting="True" AutoGenerateColumns="False" Visible="false">
                        <Columns>
