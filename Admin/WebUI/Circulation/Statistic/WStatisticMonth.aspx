<%@ Page Language="vb" AutoEventWireup="false" Inherits="eMicLibAdmin.WebUI.Circulation.WStatisticMonth" CodeFile="WStatisticMonth.aspx.vb" CodeFileBaseClass="eMicLibAdmin.WebUI.clsWBase" %>

<!DOCTYPE HTML PUBLIC "-//W3C//DTD HTML 4.0 transitional//EN">
<html>
<head>
    <title>WStatisticMonth</title>
...
<body leftmargin="0" topmargin="0">
    <form id="Form1" method="post" runat="server">
        <div id="divBody">
            <asp:Label ID="lblTitle" CssClass="main-head-form" runat="server">Thống kê lượt mượn hàng tháng trong năm: </asp:Label>
            <div class="main-form">
                ...
                <div class="ClearFix">
                    ...
                    <div class="row-detail" style="text-align: center">
                        <asp:Label ID="lblGroupTitleLoan" runat="server" Width="100%" CssClass="lbGroupTitle">Lượt mượn theo đầu ấn phẩm</asp:Label>
                        <div class="two-column">
                            <div class="two-column-form">
                                <p style="text-transform: uppercase; color: #CCA809;">Biểu đồ hình cột</p>
                                <img alt="" id="image1" src="." usemap="#map1" border="0" name="Image1" runat="server" />
                    ...
                    <div class="row-detail" style="text-align: center">
                        <asp:Label ID="lblGroupTitleLoanHistory" runat="server" Width="100%" CssClass="lbGroupTitle">Lượt trả theo đầu ấn phẩm</asp:Label>
                        <div class="two-column">
                            <div class="two-column-form">
                                <p style="text-transform: uppercase; color: #CCA809;">Biểu đồ hình cột</p>
                                <img alt="" id="image3" src="." usemap="#map3" border="0" name="Image3" runat="server">
                                <asp:Label ID="lblNostatic2" runat="server">Không có thông tin thống kê !</asp:Label>
                            </div>
                            <div class="two-column-form">
                                <p style="text-transform: uppercase; color: #CCA809;">Biểu đồ hình tròn</p>
                                <img alt="" id="image4" src="." border="0" name="Image4" runat="server">
        ...
        <asp:Label ID="lblHBarchartTitle" runat="server" Visible="False">Tháng trong năm</asp:Label>
        <asp:Label ID="lblPiechartTitle" runat="server" Visible="False">Tỷ lệ % giữa các tháng trong năm</asp:Label>
