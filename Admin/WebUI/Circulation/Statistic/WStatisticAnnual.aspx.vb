...
Namespace eMicLibAdmin.WebUI.Circulation
    Partial Class WStatisticAnnual
        Inherits clsWBase
...
#End Region
        ...
        Private Sub BindJS()
            ...
            btnCancel.Attributes.Add("OnClick", "javascript:document.forms[0].reset(); return false;")
        ...
        Private Function GetData(
            ...
            If isStat Then
                result = objBDHVLStat.GetAnnualStat(
                            isHistory,
        ...
        Private Sub StaticYear()
            ...
            If Not arrData Is Nothing Then
                If UBound(arrData) > -1 Then
                    Try
                        Call objBCommonChart.Makebarchart(arrData, arrLabel, lblVBarcharTitle.Text, lblHBarchartTitle.Text, 45, strImage, "WStatisticMonth.aspx")
                        ...
                        strOutput = Replace(strOutput, "WStatisticMonth.aspx?", "WStatisticMonth.aspx?DateTime=" + Trim(txtCheckOutDateFrom.Text) + "&")
        ...
        Protected Sub btnExportLoan_Click(sender As Object, e As EventArgs) Handles btnExportLoan.Click
            Try
                ...
                If Not IsNothing(tblResult) AndAlso tblResult.Rows.Count > 0 Then
                    ...
                    strHTMLContent.Append(clsBExportHelper.GenDataTableToString(tblResult, "Thống kê đang mượn hàng năm"))
        ...
        Protected Sub btnExportLoanHistory_Click(sender As Object, e As EventArgs) Handles btnExportLoanHistory.Click
            Try
                ...
                If Not IsNothing(tblResult) AndAlso tblResult.Rows.Count > 0 Then
                    ...
                    End If
                    Dim strHTMLContent As New StringBuilder()
                    strHTMLContent.Append(clsBExportHelper.GenDataTableToString(tblResult, "Thống kê từng mượn hàng năm"))
                    clsExport.StringBuilderToExcel(strHTMLContent)
                Else
                    ClientScript.RegisterClientScriptBlock(Me.GetType(), "NoDataExport", "alert('Không có dữ liệu để xuất!')", True)
                End If
