<%@ Page Language="vb" AutoEventWireup="false" Inherits="eMicLibAdmin.WebUI.Circulation.WStatisticDay" CodeFile="WStatisticDay.aspx.vb" CodeFileBaseClass="eMicLibAdmin.WebUI.clsWBase" %>
...
<body leftmargin="0" topmargin="0" >
    <form id="Form1" method="post" runat="server">
        <div id="divBody">
            <asp:Label ID="lblTitle" CssClass="main-head-form" Width="100%" runat="server">Thống kê số lần mượn hàng ngày trong tháng</asp:Label>
                        ...
                        <tr>
                            ...
                            <td style="padding-left:10px; padding-top:8px;">
                                ...
                                <div class="radio-control">
                                    <asp:RadioButton ID="RbtItem" runat="server" GroupName="ItemsGroup" Text="Theo đầu ấn phẩm" Checked="True"></asp:RadioButton>
                                    <asp:RadioButton ID="RbtCopynumber" runat="server" GroupName="ItemsGroup" Text="Theo bản ấn phẩm"></asp:RadioButton>
                                    <asp:RadioButton ID="RbtPatron" runat="server" GroupName="ItemsGroup" Text="Theo bạn đọc"></asp:RadioButton>
                                </div>
                            </td>
                            <td>
                                <p>&nbsp</p>
                ...
                <div class="ClearFix">
                    ...
                    <div class="row-detail" style="text-align: center">
                        <div class="two-column-form">
                            ...
                            <img id="image2" border="0" src="/" name="Image2" alt="" runat="server">
                    ...
                    <div class="row-detail" style="text-align: center">
                        <p style="text-transform: uppercase; color: #CCA809;">Biểu đồ hình cột</p>
                        <img id="image3" src="/" usemap="#map1" border="0" name="Image3" alt="" runat="server">
                        <asp:Label ID="lblNostatic2" runat="server">Không có thông tin thống kê !</asp:Label>
                    </div>
                    <div class="row-detail" style="text-align: center">
                        <p style="text-transform: uppercase; color: #CCA809;">Biểu đồ hình tròn</p>
                        <img id="image4" src="/" border="0" name="Image4" alt="" runat="server">
        ...
        <asp:Label ID="lblHBarchartTitle" runat="server" Visible="False">Ngày trong tháng</asp:Label>
        <asp:Label ID="lblPiechartTitle" runat="server" Visible="False">Tỷ lệ % giữa các ngày trong tháng</asp:Label>
        ...
        <asp:DropDownList ID="ddlLabel" runat="server" Visible="False" Height="0" Width="0">
            <asp:ListItem Value="0">STT</asp:ListItem>
                ...
                <asp:ListItem Value="5">Tháng không hợp lệ !</asp:ListItem>
                <asp:ListItem Value="6">Năm không hợp lệ !</asp:ListItem>
                <asp:ListItem Value="7">Tất cả các kho</asp:ListItem>
        </asp:DropDownList>
