<%@ Page Language="VB" AutoEventWireup="false" CodeFile="WStatRegisterLoan.aspx.vb" Inherits="eMicLibAdmin.WebUI.Circulation.WStatRegisterLoan" %>
...
<body topmargin="0" leftmargin="0">
    <form id="form1" runat="server">
         <div id="divBody">
            <div class="main-body">
                <h1 class="main-head-form">Báo cáo lượt đặt chỗ</h1>
            ...
            <div class="table-form"> 
                <asp:GridView ID="dtgResultByFileName" runat="server" AllowPaging="True" Width="100%" AutoGenerateColumns="False" PageSize="50">
                    ...
                    <Columns>
                        ...
                        <asp:BoundField DataField="DATECREATE" HeaderText="Ngày đặt chỗ" ReadOnly="true" htmlencode="false" >
                            <HeaderStyle Width="12%" HorizontalAlign="Center" />
                            <ItemStyle HorizontalAlign="Center"  />
                        </asp:BoundField>
                        <asp:BoundField DataField="CONTENT" HeaderText="Tên tài liệu" ReadOnly="true">
                        ...
                        <asp:BoundField DataField="PATRONCODE" HeaderText="Mã số thẻ" ReadOnly="true">
                            <HeaderStyle Width="12%" />
                            <ItemStyle HorizontalAlign="Center" />
                        </asp:BoundField>
        ...
        <asp:DropDownList runat="server" ID="ddlLabelHeaderTable" Visible="False" Height="0" Width="0">
            ...
            <asp:ListItem Value="1">Ngày đặt chỗ</asp:ListItem>
        ...
        <div style="display:none">
            ...
            <input name="hidTitleTable" runat="server" type="hidden" id="hidTitleTable" value="BÁO CÁO LƯỢT ĐẶT CHỖ " />
