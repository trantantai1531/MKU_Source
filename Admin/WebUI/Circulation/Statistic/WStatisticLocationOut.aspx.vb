...
Namespace eMicLibAdmin.WebUI.Circulation
    Partial Class WStatisticLocationOut
        Inherits clsWBase
        ...
        Private Sub Page_Load(ByVal sender As System.Object, ByVal e As System.EventArgs) Handles MyBase.Load
            ...
            If Page.IsPostBack = False Then
                txtCheckOutDateFrom.Text = String.Format("{0:dd/MM/yyyy}", Date.Now)
                txtCheckOutDateTo.Text = String.Format("{0:dd/MM/yyyy}", Date.Now)
        ...
        Private Function GetData(
            ...
            If isStat Then
                result = objBDHVLStat.GetCheckOutLocationStat(
            ...
            Else
                result = objBDHVLStat.GetCheckOutLocation(
                            ddlLocation.SelectedValue,
                            total,
                            txtCheckOutDateFrom.Text,
                            txtCheckOutDateTo.Text,
        ...
        Protected Sub btnExport_Click(sender As Object, e As EventArgs) Handles btnExport.Click
            Try
                ...
                If Not IsNothing(tblResult) AndAlso tblResult.Rows.Count > 0 Then
                    ...
                    strHTMLContent.Append(clsBExportHelper.GenDataTableToString(tblResult, "Thống kê ghi mượn theo từng kho"))
