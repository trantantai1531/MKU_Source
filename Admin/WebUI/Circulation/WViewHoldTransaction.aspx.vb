...
Namespace eMicLibAdmin.WebUI.Circulation
    Partial Class WViewHoldTransaction
...
#End Region
        ...
        Private Sub BindData()
            ...
            tblReserve = objBReserve.FillReserve(0, 0, "","","")
            ...
            If tblReserve.Rows.Count > 0 Then
                ...
                For Each rows As DataRow In tblReserve.Rows
                    ...
                    End If
                Next
                dgrOrderResult.DataSource = tblReserve
                dgrOrderResult.DataBind()
                'dtgResult.DataSource = tblReserve
                'dtgResult.DataBind()
            End If
        End Sub
        'Method: GetHoldTransactionList
        'Purpose: Get the HoldTransactionList Information 
        Sub GetHoldTransactionList()
            ...
            If Not tblReservList Is Nothing And Not tblGetRstCopyNumber Is Nothing AndAlso tblReservList.Rows.Count > 0 Then
                ...
                dtgResult.DataSource = tblReservList
                dtgResult.DataBind()
