...
// rdoClick function
var intOld = -1;
function rdoClick(RequestID, StatusID)
{	
	...
	document.forms[0].hidRequestID.value=RequestID;			
	parent.Sentform.document.forms[0].hidRequestID.value=RequestID;						
...
function ActFiltering(stat) {
	...
	if (stat == 10) {
		LoadAct(",2,5,6,7,14,15,16,17,");
	}
	if (stat == 11) {
		LoadAct(",2,5,6,11,14,15,16,17,");
	}
	if (stat == 12) {
		LoadAct(",2,5,6,11,14,15,16,17,");
	}
