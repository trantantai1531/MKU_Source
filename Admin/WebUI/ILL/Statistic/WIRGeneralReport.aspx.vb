' Class: WIRGeneralReport.aspx
' Puspose: Show incoming request general report
' Creator: Sondp
' CreatedDate: 25/11/2004
' Modification History:
'   13/12/2004 by Oanhtn: review

Imports eMicLibAdmin.BusinessRules.ILL

Namespace eMicLibAdmin.WebUI.ILL
    Partial Class WIRGeneralReport
        Inherits clsWBase
...
#End Region
        ...
        Private Sub ShowReport()
            ...
            tblTemp = objBILLInRCollection.CreateGeneralReport
