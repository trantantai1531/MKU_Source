' Class: WORGeneralReport.aspx
' Puspose: Show outcoming request general report
' Creator: Sondp
...
Namespace eMicLibAdmin.WebUI.ILL
    Partial Class WORGeneralReport
        Inherits clsWBase
...
#End Region
        ...
        Private Sub ShowReport()
            ...
            tblTemp = objBILLOutRCollection.CreateGeneralReport
