...
#End Region
        ...
        Private Sub BindData()
            ...
            If IsNumeric(Request("ILLID")) Then
                ...
                tblRequest = objBILLOutRequest.GetORItem

                ' Check error
                Call WriteErrorMssg(ddlLabel.Items(27).Text, objBILLOutRequest.ErrorMsg, ddlLabel.Items(28).Text, objBILLOutRequest.ErrorCode)
        ...
        Private Sub Search()
            ...
            If Trim(Request("Fields") <> "") Then
                ...
                If Not BoolArr Is Nothing And Not FieldArr Is Nothing And Not ValArr Is Nothing Then
                    strFormedSql = objBFormingSQL.FormingASQL()
                    ' Check error
                    Call WriteErrorMssg(ddlLabel.Items(27).Text, objBFormingSQL.ErrorMsg, ddlLabel.Items(28).Text, objBFormingSQL.ErrorCode)
                End If
                ...
                If intItemType <> 9 Then
                    If strFormedSql <> "" Then
                        ...
                        ' Check error
                        Call WriteErrorMssg(ddlLabel.Items(27).Text, objBCDBS.ErrorMsg, ddlLabel.Items(28).Text, objBCDBS.ErrorCode)
                    End If
                Else
        ...
        Private Sub CreateContent()
            ...
            For Each dtgItem In dgtItem.Items
                ...
                ' Check error
                Call WriteErrorMssg(ddlLabel.Items(27).Text, objBItemCollection.ErrorMsg, ddlLabel.Items(28).Text, objBItemCollection.ErrorCode)
                ...
                If intItemType = 2 And chkPerIssue.Checked Then
                    ...
                    ' Check error
                    Call WriteErrorMssg(ddlLabel.Items(27).Text, objBPeriodical.ErrorMsg, ddlLabel.Items(28).Text, objBPeriodical.ErrorCode)
