<%@ Page Language="vb" AutoEventWireup="false" Inherits="eMicLibAdmin.WebUI.ILL.WORDueMess" CodeFile="WORDueMess.aspx.vb" %>
	...
	<body topmargin="0" leftmargin="0">
		<form id="Form1" method="post" runat="server">
			<TABLE id="Table1" cellSpacing="0" cellPadding="0" width="100%" border="0">
				<TR>
					<TD colspan="2">
						<asp:Label ID="lblTitleFrom" Runat="server" CssClass="lbPageTitle" Width="100%">Thông báo quá hạn</asp:Label>
					</TD>
				</TR>
				<TR>
				...
				<TR>
					<TD colspan="2" align="center">
						...
						<asp:Button ID="btnSendMail" Runat="server" Text="Gửi thư(t)"></asp:Button>
			...
			<asp:DropDownList Runat="server" ID="ddlLabel" Width="0" Height="0" Visible="False">
				...
				<asp:ListItem Value="8">Gửi thông báo quá hạn</asp:ListItem>
			</asp:DropDownList>
