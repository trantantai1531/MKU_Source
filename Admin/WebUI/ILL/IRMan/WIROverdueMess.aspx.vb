...
#End Region
        ...
        Private Sub BindData()
            ...
            If Not tblResult Is Nothing AndAlso tblResult.Rows.Count > 0 Then
                ...
                If CInt(tblResult.Rows(0).Item("Status")) <> 8 And CInt(tblResult.Rows(0).Item("Status")) <> 9 And CInt(tblResult.Rows(0).Item("Status")) <> 11 And CInt(tblResult.Rows(0).Item("Status")) <> 12 And CInt(tblResult.Rows(0).Item("Status")) <> 13 Then
                ...
                Else
                    ...
                    End If
                    If tblResult.Rows(0).Item("Renewable") = 1 Then
                        cbkRenewable.Checked = True
                    Else
                        cbkRenewable.Checked = False
                    End If
                End If
            Else
        ...
        Private Sub btnSend_Click(ByVal sender As System.Object, ByVal e As System.EventArgs) Handles btnSend.Click
            ...
            If intSuccess > 0 Then
                ...
                strContent = objBILLInRequest.OverduXmlRecord(CStr(bitRenewable), strDueDate, strNote)
