<%@ Page Language="vb" AutoEventWireup="false" Inherits="eMicLibAdmin.WebUI.ILL.WIRSendMess" EnableViewStateMAC="False" EnableViewState="false" CodeFile="WIRSendMess.aspx.vb" CodeFileBaseClass="eMicLibAdmin.WebUI.clsWBase" %>
		...
		<form id="Form1" method="post" runat="server">
			<table id="tblEnableView" cellSpacing="3" cellPadding="2" width="100%">
				<tr class="lbPageTitle">
					<td>
						<asp:label id="lblHeader" Width="100%" Runat="server" cssClass="lbPageTitle">Gửi thông điệp</asp:label>
					</td>
				</tr>
