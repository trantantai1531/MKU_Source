<%@ Page Language="vb" AutoEventWireup="false" Inherits="eMicLibAdmin.WebUI.ILL.WIRAskstatus" CodeFile="WIRAskstatus.aspx.vb" CodeFileBaseClass="eMicLibAdmin.WebUI.clsWBase" %>
		...
		<form id="Form1" method="post" runat="server">
			<table id="tblEnableView" cellSpacing="3" cellPadding="2" width="100%">
				<tr class="lbPageTitle">
					<td><asp:label id="lblHeader" cssClass="lbPageTitle" Runat="server" Width="100%">Gửi yêu cầu hỏi trạng thái</asp:label></td>
				</tr>
