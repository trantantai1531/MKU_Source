<%@ Page Language="vb" AutoEventWireup="false" Inherits="eMicLibAdmin.WebUI.ILL.WIRExtend" CodeFile="WIRExtend.aspx.vb" CodeFileBaseClass="eMicLibAdmin.WebUI.clsWBase" %>
<!DOCTYPE HTML PUBLIC "-//W3C//DTD HTML 4.0 Transitional//EN">
<HTML>
	<HEAD>
		<title>Thông điệp gia hạn mượn ấn phẩm</title>
		...
		<form id="Form1" method="post" runat="server">
			<table id="tblEnableView" cellSpacing="3" cellPadding="2" width="100%">
				<tr class="lbPageTitle">
					<td>
						<asp:label id="lblHeader" Runat="server" cssClass="lbPageTitle" Width="100%">Thông điệp gia hạn mượn ấn phẩm</asp:label>
					</td>
				</tr>
				<tr>
					<td>
						<asp:label id="lblAreyouSure" Runat="server">Chấp nhận gia hạn?</asp:label>
						&nbsp;&nbsp;&nbsp;&nbsp;
				...
				<tr>
					<td>
						<asp:Label ID="lblDueDate" Runat="server"><u>N</u>gày hết hạn:</asp:Label>&nbsp;
						<asp:textbox id="txtDueDate" Runat="server"></asp:textbox>&nbsp;
						<asp:HyperLink ID="lnkDueDate" Runat="server">Lịch</asp:HyperLink>
						&nbsp;&nbsp;&nbsp;&nbsp;
						<asp:CheckBox ID="cbkRenewable" Runat="server" Text="Có thể gi<u>a</u> hạn" Checked="True"></asp:CheckBox>
					</td>
				</tr>
			...
			<input id="ipLogID" type="hidden" name="ipLogID" runat="server" value="0"> <input id="ipRenewals" type="hidden" name="ipRenewals" runat="server" value="0">
