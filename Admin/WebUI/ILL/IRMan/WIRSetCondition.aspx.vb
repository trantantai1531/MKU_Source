' class WIRSetCondition.aspx
' Puspose: Set the condition to borrow
' Creator: Sondp
...
#End Region
        ...
        Private Sub BindData()
            ...
            If Not tblResult Is Nothing AndAlso tblResult.Rows.Count > 0 Then
                ...
                If Not IsDBNull(tblResult.Rows(0).Item("EXPIRYDATE")) Then
                    If CStr(tblResult.Rows(0).Item("EXPIRYDATE")) <> "" Then
                        lblExpiryDate.Visible = True
                        lblExpiryDate.Text = lblExpiryDate.Text & CStr(tblResult.Rows(0).Item("EXPIRYDATE"))
                    End If
                End If
                ...
                Else
                    'get data
                    tblResult = Nothing
                    objBILLInRequest.IDs = "13,14,15,16,22,23,24,25,27,28"
                    tblResult = objBILLInRequest.GetIllResponse
                    ' Write Error
                    Call WriteErrorMssg(ddlLabel.Items(0).Text, objBILLInRequest.ErrorMsg, ddlLabel.Items(1).Text, objBILLInRequest.ErrorCode)

                    If Not tblResult Is Nothing AndAlso tblResult.Rows.Count > 0 Then
                        ddlDelivConditionID.DataSource = tblResult
        ...
        Private Sub btnSend_Click(ByVal sender As System.Object, ByVal e As System.EventArgs) Handles btnSend.Click
            ...
            If intSuccess > 0 Then
                ...
                strContent = objBILLInRequest.CondiXmlRecord(CStr(intDelivConditionID), strProvidedDate, strNote)
