<%@ Page Language="vb" AutoEventWireup="false" Inherits="eMicLibAdmin.WebUI.ILL.WIRRequestHistory" CodeFile="WIRRequestHistory.aspx.vb" CodeFileBaseClass="eMicLibAdmin.WebUI.clsWBase" %>
		...
		<form id="Form1" method="post" runat="server">
			<TABLE id="Table1" cellSpacing="0" cellPadding="2" width="100%" border="0">
				<TR class="lbPageTitle">
					<TD><asp:label id="lblPageTitle" runat="server" Width=100% CssClass="lbPageTitle">Lịch sử yêu cầu</asp:label></TD>
				</TR>
				<TR>
					<td>
				...
				<TR>
					<TD align="center"><asp:button id="btnClose" runat="server" Text="Đóng (c)">
						</asp:button><asp:dropdownlist id="ddlLabel" Runat="server" width="0" Height="0" Visible="False">
							...
							<asp:ListItem Value="28">Ngày hết hạn</asp:ListItem>
							<asp:ListItem Value="29">Có thể gia hạn tiếp</asp:ListItem>
							<asp:ListItem Value="30">Ngày quá hạn</asp:ListItem>
						</asp:dropdownlist></TD>
				</TR>
			</TABLE>
