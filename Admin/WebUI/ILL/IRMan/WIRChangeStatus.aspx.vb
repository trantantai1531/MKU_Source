...
#End Region
        ...
        Private Sub BindJavascript()
            ...
            btnNoChange.Attributes.Add("Onclick", "javascript:self.close()")
        End Sub
        ...
        Private Sub btnChange_Click(ByVal sender As System.Object, ByVal e As System.EventArgs) Handles btnChange.Click
            ...
            Dim tblResult As DataTable
            Dim intChangeType As Integer = 0
            ...
            Else
                strRequestDate = "NULL"
            End If
            intChangeType = ddlStatus.SelectedValue

            'update ill_incoming_request
            Call objBILLInRequest.InitVariables()
            objBILLInRequest.ILLID = intIllID
            objBILLInRequest.Status = intChangeType
            ...
            If intSuccess > 0 Then
                ...
                objBILLInRequest.Note = lblHeader.Text & " (" & ddlStatus.SelectedItem.Text & ")"
            ...
            If intSuccess > 0 Then
                ...
                strContent = objBILLInRequest.MessagXmlRecord(objBILLInRequest.Note)
