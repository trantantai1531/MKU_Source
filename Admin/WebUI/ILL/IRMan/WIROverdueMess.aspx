<%@ Page Language="vb" AutoEventWireup="false" Inherits="eMicLibAdmin.WebUI.ILL.WIROverdueMess" CodeFile="WIROverdueMess.aspx.vb" CodeFileBaseClass="eMicLibAdmin.WebUI.clsWBase" %>
<!DOCTYPE HTML PUBLIC "-//W3C//DTD HTML 4.0 Transitional//EN">
<HTML>
	<HEAD>
		<title>Thông điệp báo quá hạn mượn ấn phẩm</title>
		...
		<form id="Form1" method="post" runat="server">
			<table id="tblEnableView" cellSpacing="3" cellPadding="2" width="100%">
				<tr class="lbPageTitle">
					<td>
						<asp:label id="lblHeader" Width="100%" Runat="server" cssClass="lbPageTitle">Thông điệp báo quá hạn mượn ấn phẩm</asp:label>
					</td>
				</tr>
				<tr>
					<td><asp:label id="lblDueDate" Runat="server"><u>N</u>gày hết hạn:</asp:label>&nbsp;
