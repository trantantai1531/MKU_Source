<%@ Page Language="vb" AutoEventWireup="false" Inherits="eMicLibAdmin.WebUI.ILL.WIRSetCondition" CodeFile="WIRSetCondition.aspx.vb" CodeFileBaseClass="eMicLibAdmin.WebUI.clsWBase" %>
<!DOCTYPE HTML PUBLIC "-//W3C//DTD HTML 4.0 Transitional//EN">
<HTML>
	<HEAD>
		<title>Thông điệp trả lời có kèm điều kiện</title>
		...
		<form id="Form1" method="post" runat="server">
			<table id="tblEnableView" cellSpacing="3" cellPadding="2" width="100%">
				<tr class="lbPageTitle">
					<td>
						<asp:label id="lblHeader" Width="100%" Runat="server" cssClass="lbPageTitle">Thông điệp trả lời có kèm điều kiện</asp:label>
					</td>
				</tr>
				<tr>
					<td>
						<table cellpadding="1" cellspacing="1" width="100%">
							<tr>
								<td align="right" width="20%">
									<asp:label id="lblReason" Runat="server">Điều kiệ<u>n</u>:</asp:label>
								</td>
								<td>
							...
							<tr>
								<td align="right">
									<asp:label id="lblProvidedDate" Runat="server"></u>H</u>ạn trả lời:</asp:label>
								</td>
								<td>
				...
				<tr>
					<td>
						<asp:Label ID="lblExpiryDate" Runat="server">Ngày yêu cầu hết hạn: </asp:Label>
					</td>
				</tr>
