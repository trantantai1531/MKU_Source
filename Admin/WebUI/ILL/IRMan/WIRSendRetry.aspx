<%@ Page Language="vb" AutoEventWireup="false" Inherits="eMicLibAdmin.WebUI.ILL.WIRSendRetry" CodeFile="WIRSendRetry.aspx.vb" CodeFileBaseClass="eMicLibAdmin.WebUI.clsWBase" %>
<!DOCTYPE HTML PUBLIC "-//W3C//DTD HTML 4.0 Transitional//EN">
<HTML>
	<HEAD>
		<title>Thông điệp đề nghị gửi lại yêu cầu vào lúc khác</title>
		...
		<form id="Form1" method="post" runat="server">
			<table id="tblEnableView" cellSpacing="3" cellPadding="2" width="100%">
				<tr class="lbPageTitle">
					<td>
						<asp:label id="lblHeader" Runat="server" Width="100%" cssClass="lbPageTitle">Thông điệp đề nghị gửi lại yêu cầu vào lúc khác</asp:label>
					</td>
				</tr>
				<tr>
					<td>
						<table cellpadding="1" cellspacing="1" width="100%">
							<tr>
								<td align="right" width="20%">
									<asp:label id="lblReason" Runat="server">Ng<u>u</u>yên nhân:</asp:label>
								</td>
								<td>
							...
							<tr>
								<td align="right">
									<asp:label id="lblProvidedDate" Runat="server"><u>N</u>gày nên gửi lại:</asp:label>
								</td>
								<td>
