...
Namespace eMicLibAdmin.WebUI.News
    Partial Class News_TypeWebUsefulAdd
        ...
        Protected Sub Page_Load(ByVal sender As Object, ByVal e As System.EventArgs) Handles Me.Load
            ...
            If Not Page.IsPostBack Then
                Call BindData()
                lblPageHeader.Text = "Thêm mới Website hữu ích"
        ...
        Public Sub News_sl_id()
            Try
                lblPageHeader.Text = "Chỉnh sửa  Website hữu ích"
        ...
        Protected Sub bt_nhap_Click(ByVal sender As Object, ByVal e As EventArgs) Handles btnLuu.Click
            Try
                ...
                If txtLink.Text <> "" Then
                    If ValidatewebsiteAddress(txtLink.Text) = False Then
                        Thong_bao("Vui lòng nhập đúng URL")
                        txtLink.Focus()
                        Return
                    End If
                End If
                ...
                If lbl_tam.Text.Trim().Length > 0 Then
                    ...
                    Else
                        ...
                        Else
                            ...
                            'Lấy đuôi file
                            Tenfile = clsWCommon.Filename(txt_Loai.Text.Trim().ToString())
                ...
                Else
                    ...
                    Else
                        ext = clsWCommon.GetExtFile(fn)
                        Tenfile = clsWCommon.Filename(txt_Loai.Text.ToString())
                    End If
                    ...
                    If id <> 0 Then
                        ...
                        clsWCommon.CreateThumbnail(dir, 60, 60)
                    Else
