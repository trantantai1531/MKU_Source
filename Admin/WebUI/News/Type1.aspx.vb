    ...
    Partial Class Type1
        ...
        Public Sub BindData()
            Try
                ...
                If objBType.id_L = "0" Then
                    lblHeaderInfo.Text = "Nhóm tin tức"
                ElseIf objBType.id_L = "1" Then
                    lblHeaderInfo.Text = "Nhóm website"
                ElseIf objBType.id_L = "2" Then
                    lblHeaderInfo.Text = "Nhóm định dạng"
                ElseIf objBType.id_L = "3" Then
                    lblHeaderInfo.Text = "Nhóm số trang"
                ElseIf objBType.id_L = "4" Then
                    lblHeaderInfo.Text = "Nhóm ngôn ngữ"
                ElseIf objBType.id_L = "5" Then
                    lblHeaderInfo.Text = "Nhóm trình độ"
