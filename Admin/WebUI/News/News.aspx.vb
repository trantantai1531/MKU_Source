...
#End Region
        ...
        Public Sub PhanLoai()
            Try
                ...
                objBType.NN = "vn"
                objBType.id_L = Int(Request.QueryString.Get("id"))
                objBType.LibID = clsSession.GlbSite
                tbType = objBType.CAT_Type_sl_all()

                ddlGroupNew.DataSource = tbType
                ddlGroupNew.DataTextField = "Loai"
                ddlGroupNew.DataValueField = "id"
                ddlGroupNew.DataBind()
        ...
        Private Sub BindData()
            ...
            'If ddlGroupNew.SelectedValue <> "" Then
            '    objBNews.id_L = Int(ddlGroupNew.SelectedValue)
            'End If
        ...
        Public Sub Data()
            Try
                ...
                GridView1.DataSource = tblNews
                GridView1.DataBind()
                If ddlGroupNew.SelectedIndex = 0 Then
                    GridView1.Columns(0).Visible = False
                Else
        ...
        Protected Sub ddlGroupNew_SelectedIndexChanged(ByVal sender As Object, ByVal e As EventArgs) Handles ddlGroupNew.SelectedIndexChanged
            Call Data()
        End Sub
