<%@ Page Language="VB" AutoEventWireup="false" MasterPageFile="~/News/Admin.Master"  CodeFile="TypeWebUsefulAdd.aspx.vb" Inherits="eMicLibAdmin.WebUI.News.News_TypeWebUsefulAdd" %>
   ...
   <div class="row">
      <div class="col-lg-12">
         <h1 class="page-header">
             <asp:Label ID="lblPageHeader" runat="server" Text="Label"></asp:Label></h1>
      </div>
      <!-- /.col-lg-12 -->
   </div>
   <!-- /.row -->
               ...
               <div class="row">
                  <div class="col-lg-12">
                    ...
                    <div class="form-group">
                     ...
                     <div class="form-group">
                        <label>Tiêu đề</label>
                        <asp:TextBox ID="txt_Loai" MaxLength="100" runat="server" CssClass="tipS form-control" Width="70%"  placeholder="(*) Đây là thông tin bắt buộc " ></asp:TextBox>
