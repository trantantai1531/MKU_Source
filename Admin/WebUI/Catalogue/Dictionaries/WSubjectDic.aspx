<%@ Page Language="vb" AutoEventWireup="false" Inherits="eMicLibAdmin.WebUI.Catalogue.WEngVnDic" CodeFile="WSubjectDic.aspx.vb" CodeFileBaseClass="eMicLibAdmin.WebUI.clsWBase" %>
                ...
                <div class="input-control row-detail">
                    <div class="table-form">
                        ...
                        <telerik:RadGrid ID="dtgDicData" runat="server" AllowPaging="True"
                            CellSpacing="0"
                            AutoGenerateColumns="False" Skin="Office2010Black" GridLines="None" OnNeedDataSource="dtgdtgDicData_NeedDataSource">
                            <MasterTableView TableLayout="Auto" DataKeyNames="ID" EditMode="InPlace">
                                ...
                                <Columns>
                                    ...
                                    <telerik:GridTemplateColumn HeaderText="Subject" ItemStyle-Width="8%">
                                        <ItemTemplate>
                                            <asp:Label ID="LblCode" Text='<%# DataBinder.Eval(Container.DataItem, "Subject")%>' runat="server">
                                            </asp:Label>
                                        </ItemTemplate>
                                        <EditItemTemplate>
                                            <asp:TextBox Width="300" CssClass="lbTextBox" runat="server" ID="txtEnglishVocabulary" Text='<%# DataBinder.Eval(Container.DataItem, "Subject")%>' />
                                        </EditItemTemplate>
                                    </telerik:GridTemplateColumn>


                                    <telerik:GridTemplateColumn HeaderText="Parent" ItemStyle-Width="8%">
                                        <ItemTemplate>
                                            <asp:Label ID="LblParentSubject" Text='<%# DataBinder.Eval(Container.DataItem, "ParentSubject")%>' runat="server">
                                            </asp:Label>
                                        </ItemTemplate>
                                        <EditItemTemplate>
                                          <%--  <asp:TextBox Width="300" CssClass="lbTextBox" runat="server" ID="txtMean" Text='<%# DataBinder.Eval(Container.DataItem, "Mean")%>' />--%>
                                            
                                            <asp:DropDownList ID="ddlSubject" runat="server" AutoPostBack="true" DataValueField="Product_Id"
