<%@ Page Language="vb" AutoEventWireup="false" Inherits="eMicLibAdmin.WebUI.Catalogue.WCataDetailTaskbar" CodeFile="WCataDetailTaskbar.aspx.vb" CodeFileBaseClass="eMicLibAdmin.WebUI.clsWBase" %>
		...
		<form id="frm" method="post" runat="server">
			<TABLE cellSpacing="0" cellPadding="2" width="100%" border="0">
				<TR>
					...
					<TD align="left">
						<asp:button id="btnRenew" runat="server" Text="Duyệt (r)" CssClass="lbButton" Visible="False"></asp:button>
						&nbsp;&nbsp;
			...
			<P>
				...
				<asp:DropDownList Runat="server" ID="ddlLabel" Visible="False" Width="0" Height="0">
					<asp:ListItem Value="0">Bạn chưa lựa chọn ấn phẩm cần duyệt!</asp:ListItem>
					...
					<asp:ListItem Value="5">Chỉ có những ấn phẩm biên mục đã qua biên mục chi tiết bạn mới được duyệt. Bạn có đồng ý ấn phẩm này duyệt không?</asp:ListItem>
				</asp:DropDownList></P>
			<P>&nbsp;</P>
		</form>
	</body>
