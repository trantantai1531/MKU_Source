...
Namespace eMicLibAdmin.WebUI.Catalogue
    Partial Class WCataDetailTaskbar
        Inherits clsWBase
...
#End Region
        ...
        Private Sub BindJS()
            ...
            btnDelete.Attributes.Add("onclick", "javascript:if (CheckNull(parent.Workform.document.forms[0].hidIDs)) {alert('" & ddlLabel.Items(3).Text & "');} else{if (window.confirm('" & ddlLabel.Items(4).Text & "')) {parent.Workform.document.location.href='WCataDetail.aspx?strDelete=' + parent.Workform.document.forms[0].hidIDs.value;}}return false;")
            btnRenew.Attributes.Add("onclick", "javascript:if (CheckNull(parent.Workform.document.forms[0].hidIDs)) {alert('" & ddlLabel.Items(3).Text & "');} else{if (window.confirm('" & ddlLabel.Items(5).Text & "')) {parent.Workform.document.location.href='WCataDetail.aspx?strUpdate=' + parent.Workform.document.forms[0].hidIDs.value;}}return false;")
            Page.RegisterClientScriptBlock("LoadWorkForm", "<script language='javascript'>parent.Workform.location.href = 'WCataDetail.aspx';</script>")
        End Sub
