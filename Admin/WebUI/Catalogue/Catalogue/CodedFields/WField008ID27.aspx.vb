...
#End Region
        ...
        Private Sub BindJS()
            ...
            btnPreview.Attributes.Add("OnClick", "javascript:PreView(15); return false;")
            btnUpdate.Attributes.Add("OnClick", "javascript:Update(15);")
            ...
            ddlLanguage.Attributes.Add("OnChange", "javascript: LoadTextData('ddlLanguage','txtField13');")
