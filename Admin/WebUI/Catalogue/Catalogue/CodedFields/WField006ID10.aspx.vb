...
#End Region
        ...
        Private Sub BindJavascripts()
            ...
            btnPreview.Attributes.Add("OnClick", "javascript:PreView(4); return false;")
            btnUpdate.Attributes.Add("OnClick", "javascript:Update(4)")
