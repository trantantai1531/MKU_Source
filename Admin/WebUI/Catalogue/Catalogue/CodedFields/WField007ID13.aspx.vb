...
#End Region
        ...
        Private Sub BindJS()
            ...
            Dim strJS As String = ""
            strJS = strJS & "var intFileID = 13;" & Chr(13)
            ...
            btnPreview.Attributes.Add("OnClick", "javascript:PreView(6); return false;")
            btnUpdate.Attributes.Add("OnClick", "javascript:Update(6)")
