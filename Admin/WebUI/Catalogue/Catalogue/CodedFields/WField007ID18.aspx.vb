...
#End Region
        ...
        Private Sub BindJS()
            ...
            btnPreview.Attributes.Add("OnClick", "javascript:PreView(18); return false;")
            btnUpdate.Attributes.Add("OnClick", "javascript:Update(18)")
