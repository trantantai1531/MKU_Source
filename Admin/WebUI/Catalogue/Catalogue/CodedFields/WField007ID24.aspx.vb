...
#End Region
        ...
        Private Sub BindJS()
            ...
            btnPreview.Attributes.Add("OnClick", "javascript:PreView(2); return false;")
            btnUpdate.Attributes.Add("OnClick", "javascript:Update(2)")
