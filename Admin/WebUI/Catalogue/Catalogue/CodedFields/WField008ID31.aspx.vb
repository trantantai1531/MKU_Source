...
#End Region
        ...
        Private Sub BindJS()
            ...
            btnPreview.Attributes.Add("OnClick", "javascript:PreView(11); return false;")
            btnUpdate.Attributes.Add("OnClick", "javascript:Update(11)")
            ...
            ddlLanguage.Attributes.Add("OnChange", "javascript: LoadTextData('ddlLanguage','txtField9');")
