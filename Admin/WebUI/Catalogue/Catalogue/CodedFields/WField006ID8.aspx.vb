...
#End Region
        ...
        Private Sub BindJS()
            ...
            btnPreview.Attributes.Add("OnClick", "javascript:PreView(14); return false;")
            btnUpdate.Attributes.Add("OnClick", "javascript:Update(14)")
