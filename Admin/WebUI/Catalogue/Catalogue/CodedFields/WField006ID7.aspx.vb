...
#End Region
        ...
        Private Sub BindJS()
            ...
            ddlTemp7.Attributes.Add("OnChange", "javascript: LoadTextData('ddlTemp7','txtField7');")
            ddlTemp8.Attributes.Add("OnChange", "javascript: LoadTextData('ddlTemp8','txtField8');")

            btnPreview.Attributes.Add("OnClick", "javascript:PreView(9); return false;")
            btnUpdate.Attributes.Add("OnClick", "javascript:Update(9)")
