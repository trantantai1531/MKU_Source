...
#End Region
        ...
        Private Sub BindJS()
            ...
            ddlTemp6.Attributes.Add("Onchange", "LoadTextData('ddlTemp6','txtField6');")
            btnPreview.Attributes.Add("OnClick", "javascript:PreView(7); return false;")
            btnUpdate.Attributes.Add("OnClick", "javascript:Update(7)")
