<%@ Page Language="vb" AutoEventWireup="false" Inherits="eMicLibAdmin.WebUI.Catalogue.WField007ID19" CodeFile="WField007ID19.aspx.vb" CodeFileBaseClass="eMicLibAdmin.WebUI.clsWBase" %>
<!DOCTYPE HTML PUBLIC "-//W3C//DTD HTML 4.0 Transitional//EN">
<HTML>
	<HEAD>
		<title>WField007ID19</title>
	...
	<body leftMargin="0" topMargin="0" onload="ResValue(19);">
		<form id="Form1" method="post" runat="server">
			<TABLE id="Table1" cellSpacing="3" cellPadding="0" width="100%" border="0">
				<TR vAlign="top" class="lbpageTitle">
					<TD vAlign="top" colSpan="2">
						<asp:label id="lblTitle" runat="server" CssClass="lbPageTitle" Width="100%"> 007--KIT</asp:label></TD>
				</TR>
				...
				<TR vAlign="top" class="lbControlBar">
					<TD vAlign="top" colSpan="2">
						...
						<asp:button id="btnReset" runat="server" Text="Ðặt lại(l)" Width="73px"></asp:button>&nbsp;
						<asp:button id="btnPreview" runat="server" Text="Xem(x)" Width="63px"></asp:button>
