...
#End Region
        ...
        Private Sub BindJS()
            ...
            btnPreview.Attributes.Add("OnClick", "javascript:PreView(16); return false;")
            btnUpdate.Attributes.Add("OnClick", "javascript:Update(16)")
            ...
            ddlField11.Attributes.Add("OnChange", "javascript: LoadTextData('ddlField11','txtField11');")
            ddlTemp12.Attributes.Add("OnChange", "javascript: LoadTextData('ddlTemp12','txtField12');")
            ddlLanguage.Attributes.Add("OnChange", "javascript: LoadTextData('ddlLanguage','txtField14');")
