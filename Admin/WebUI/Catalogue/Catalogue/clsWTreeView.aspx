<%@ Page Language="vb" AutoEventWireup="false" Inherits="eMicLibAdmin.WebUI.Catalogue.clsWTreeView" CodeFile="clsWTreeView.aspx.vb" CodeFileBaseClass="eMicLibAdmin.WebUI.clsWBase" %>
				...
				<TR runat="server" id="TRSearch">
					<td>
						<table border="0" cellpadding="2" cellspacing="0" width="100%">
							...
							<tr>
								<td>
									<asp:Label runat="server" ID="lblPath" CssClass="lbLabel" style="Z-INDEX: 101"><u>Đ</u>ường dẫn:</asp:Label>
								</td>
							</tr>
							<tr>
								<td>
									<asp:TextBox id="txtPhysicalPath" runat="server" Width="168px" CssClass="lbTextBox" style="Z-INDEX: 102"></asp:TextBox>
								</td>
							</tr>
							<tr>
								<td>
									<asp:Label runat="server" ID="lblStatus" CssClass="lbLabel" style="Z-INDEX: 103"><u>T</u>rạng thái:</asp:Label>
								</td>
							</tr>
							<tr>
								<td>
									<asp:DropDownList id="ddlStatus" runat="server" style="Z-INDEX: 104">
							...
							<tr>
								<td>
									<asp:Label id="lblMediaType" runat="server" CssClass="lbLabel" style="Z-INDEX: 105">Địn<u>
											h</u> dạng dữ liệu:</asp:Label>
								</td>
							</tr>
							<tr>
								<td>
									<asp:ListBox id="lstMediaType" runat="server" SelectionMode="Multiple" style="Z-INDEX: 106">
							...
							<tr>
								<td>
									<asp:Label id="lblCollection" runat="server" CssClass="lbLabel" style="Z-INDEX: 107"><u>
											B</u>ộ sưu tập:</asp:Label>
								</td>
							</tr>
							<TR>
								<TD>
									<asp:DropDownList id="ddlCollection" runat="server" style="Z-INDEX: 108"></asp:DropDownList></TD>
							</TR>
							<TR>
								<TD>
									<asp:Label id="lblSecretLevel" runat="server" CssClass="lbLabel" style="Z-INDEX: 109">Cấp độ <u>
											m</u>ật:</asp:Label></TD>
							</TR>
							<TR>
								<TD>
									<asp:DropDownList id="ddlSecretParam" runat="server" style="Z-INDEX: 110">
										<asp:ListItem Value=">=">>=</asp:ListItem>
										<asp:ListItem Value="<="><=</asp:ListItem>
									</asp:DropDownList>&nbsp;
									<asp:DropDownList id="ddlSecretLevel" runat="server" style="Z-INDEX: 111">
							...
							<TR>
								<TD>
									<asp:Label id="lblSize" runat="server" CssClass="lbLabel" style="Z-INDEX: 112"><u>K</u>ích thước tệp:</asp:Label></TD>
							</TR>
							<TR>
								<TD>
									<asp:DropDownList id="ddlSizePara" runat="server" style="Z-INDEX: 113">
										<asp:ListItem Value=">=">>=</asp:ListItem>
										<asp:ListItem Value="<="><=</asp:ListItem>
									</asp:DropDownList>&nbsp;
									<asp:TextBox id="txtSize" runat="server" Width="80px" CssClass="lbTextBox" style="Z-INDEX: 114"></asp:TextBox>&nbsp;
							...
							<TR>
								<TD>
									<asp:Button id="btnSearch" runat="server" Width="96px" Text="Tìm kiếm (s)" CssClass="lbButton"
										AccessKey="s"></asp:Button></TD>
							</TR>
						</table>
					</td>
				</TR>
