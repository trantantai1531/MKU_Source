<%@ Page Language="vb" AutoEventWireup="True" EnableViewState="True" EnableViewStateMAC="False" Inherits="eMicLibAdmin.WebUI.Catalogue.WImportDataExcel" CodeFile="WImportDataExcel.aspx.vb" CodeFileBaseClass="eMicLibAdmin.WebUI.clsWBase" %>
                ...
                <div class="span5">
                    <div class="row-detail">
                        ...
                        <div class="input-control" id="Div1" runat="server">
                            ...
                            <asp:Label ID="lbCopyNumberExist" runat="server" Text=""></asp:Label><br />
                        </div>
                    </div>
                </div>
            </div>
