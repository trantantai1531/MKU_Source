<%@ Page Language="VB" AutoEventWireup="false" CodeFile="WAddSH.aspx.vb" Inherits="eMicLibAdmin.WebUI.Cataloguer.WAddSH" %>
...
<body topmargin="0" leftmargin="0">
                ...
                <div class="two-column ClearFix">
                    ...
                    <div class="span4">
                        <div class="row-detail">
                            ...
                            <div class="button-control">
                                <div class="button-form">
                                    <asp:TextBox ID="txtSHSearch" runat="server"></asp:TextBox>
                                </div>
                                <div class="button-form">
                                    <asp:Button ID="btnSearchSH" CssClass="form-btn" runat="server" Text="Tìm kiếm" />
                                </div>
                            </div>
                        </div>
                    </div>
                    ...
                    <asp:GridView ID="dtgPolicy" runat="server" AllowPaging="True" Width="100%" AutoGenerateColumns="False" PageSize="100">
                        ...
                        <Columns>
                            ...
                            <asp:TemplateField HeaderText="Từ khóa">
                                ...
                                <ItemTemplate>
                                    <asp:Label ID="lblSH" Text='<%# Eval("DisplayEntry")%>' runat="server" />
                                </ItemTemplate>
                                <EditItemTemplate>
                                    <asp:HiddenField ID="hidID" Value='<%# Eval("ID")%>' runat="server" />
                                    <asp:TextBox ID="txtSHModify" Text='<%# Eval("DisplayEntry")%>' runat="server"></asp:TextBox>
                                </EditItemTemplate>
                            </asp:TemplateField>
                            <asp:TemplateField>
                                <ItemTemplate>
                                    <a href="#" onclick="ClickSH('<%# Eval("ID")%>','<%# Eval("DisplayEntry")%>')">
    ...
    <script type="text/javascript">
        function ClickSH(intSHID,strDisplayEntry)
        {
            location.href = "WAddSH.aspx?intSHID=" + intSHID + "&strDisplayEntry=" + strDisplayEntry;
