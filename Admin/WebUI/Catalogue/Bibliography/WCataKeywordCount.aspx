<%@ Page Language="VB" AutoEventWireup="false" CodeFile="WCataKeywordCount.aspx.vb" Inherits="eMicLibAdmin.WebUI.Circulation.WCataKeywordCount" %>
...
<body topmargin="0" leftmargin="0">
    <form id="Form1" method="post" runat="server">
        <div id="divBody">
            <div class="main-body">
                <h1 class="main-head-form">Danh mục số lượng tài liệu theo từ khóa</h1>
