<%@ Page Language="VB" AutoEventWireup="false" CodeFile="WCataSHCount.aspx.vb" Inherits="eMicLibAdmin.WebUI.Cataloguer.WCataSHCount" %>
...
<body topmargin="0" leftmargin="0">
    <form id="Form1" method="post" runat="server">
        <div id="divBody">
            <div class="main-body">
                <h1 class="main-head-form">DANH MỤC SỐ LƯỢNG TÀI LIỆU THEO NGÀNH</h1>
                ...
                <div class="table-form">
                    <asp:GridView ID="dtgPolicy" runat="server" AllowPaging="True" Width="100%" AutoGenerateColumns="False" PageSize="100">
                        ...
                        <Columns>
                            ...
                            <asp:BoundField DataField="CountCopyNumber" HeaderText="Số lượng" ReadOnly="true">
                                <HeaderStyle Width="7.5%" HorizontalAlign="Center" />
                                <ItemStyle HorizontalAlign="Center" />
                            </asp:BoundField>
        ...
        <asp:DropDownList runat="server" ID="ddlLabelHeaderTable" Visible="False" Height="0" Width="0">
            ...
            <asp:ListItem Value="3">Nơi xuất bản</asp:ListItem>
            <asp:ListItem Value="4">Nhà xuất bản</asp:ListItem>
            <asp:ListItem Value="5">Năm xuất bản</asp:ListItem>
            <asp:ListItem Value="6">Số phân loại</asp:ListItem>
            <asp:ListItem Value="7">Ngành học</asp:ListItem>
            <asp:ListItem Value="8">Số lượng</asp:ListItem>
            <asp:ListItem Value="9">Dạng tài liệu</asp:ListItem>
        </asp:DropDownList>
