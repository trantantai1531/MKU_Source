<%@ Page Language="vb" AutoEventWireup="false" Inherits="eMicLibAdmin.WebUI.Catalogue.WCatPatternPreview" validateRequest="false" EnableViewState="False" EnableViewStateMAC="False" CodeFile="WCatPatternPreview.aspx.vb" CodeFileBaseClass="eMicLibAdmin.WebUI.clsWBase" %>
<!DOCTYPE HTML PUBLIC "-//W3C//DTD HTML 4.0 Transitional//EN">
<HTML>
	<HEAD>
		<title>Emiclib - Phân hệ biên mục - Xem khuôn dạng sản phẩm thư mục</title>
	...
	<body topmargin="0" leftmargin="0" rightmargin="0" bottommargin="0">
		<form id="Form1" method="post" runat="server">
			<Table id="PreviewTemplate" width="100%">
				<tr class="lbPageTitle">
					<td width="100%" align="center">
					    <h1 class="main-group-form">   <asp:Label ID="lblMainTitle" Runat="server" cssClass="lbPageTitle">Xem khuôn dạng sản phẩm thư mục</asp:Label></h1>
					 
					</td>
				</tr>
				<tr>
					<td><asp:Label ID="lblContent" Runat="server" Width="100%"></asp:Label></td>
				</tr>
				<tr>
