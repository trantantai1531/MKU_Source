...
Namespace eMicLibAdmin.WebUI.Circulation
    Partial Class WCataKeywordCount
        ...
        Private Sub BindData(ByVal intKeywordId As Integer, Optional ByVal intTypeId As Integer = 0, Optional ByVal intLoanType As Integer = 0)
            Try
                ...
                Dim tblResult As DataTable = objBItem.GetItemByKeywordCount(intKeywordId, intTypeId, intLoanType, yearFrom, yearTo, intAcqSource, intLocation)
        ...
        Private Sub BindData(ByVal strKeyword As String, Optional ByVal intTypeId As Integer = 0, Optional ByVal intLoanType As Integer = 0)
            Try
                ...
                Dim tblResult As DataTable = objBItem.GetItemByKeywordCount(strKeyword, intTypeId, intLoanType, yearFrom, yearTo, intAcqSource, intLocation)
                Dim totalRecord As Double = 0
                Dim totalCopyNumber As Double = 0
                ResultSearch(tblResult, totalRecord, totalCopyNumber)
        ...
        Protected Sub btnExportWord_Click(sender As Object, e As EventArgs) Handles btnExportWord.Click
            ...
            If rdDDLKeyword.Checked = True Then
                tblResult = objBItem.GetItemByKeywordCount(CInt(ddlKeyword.SelectedItem.Value), CInt(ddlItemType.SelectedValue), CInt(ddlLoanType.SelectedValue), yearFrom, yearTo, intAcqSource, intLocation)
            End If
            If rdTextKeyword.Checked = True Then
                tblResult = objBItem.GetItemByKeywordCount(txtKeyword.Text, CInt(ddlItemType.SelectedValue), CInt(ddlLoanType.SelectedValue), yearFrom, yearTo, intAcqSource, intLocation)
            End If
