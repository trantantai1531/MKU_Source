	...
	*/
	...
	if (dom) {
		...
		document.write ('<div onclick="bShow=true" id="calendar" style="z-index:+999;position:absolute;visibility:hidden;"><table width="'+((showWeekNumber==1)?250:220)+'" style="font-family:Arial;font-size:11px;border: 0px solid #A0A0A0;" bgcolor="#ffffff" height="220"><tr bgcolor="#1e5c99"><td height="22"><table width="'+((showWeekNumber==1)?248:218)+'"><tr><td style="padding:2px;font-family:Arial;font-size:11px;"><font color="#ffffff' + '' /*C9D3E9*/ +'"><b><span id="caption"></span></b></font></td></tr></table></td></tr><tr><td style="padding:5px" bgcolor="#ffffff"><span id="content"></span></td></tr>');

		if (showToday == 1) {
			document.write ('<tr bgcolor="#f0f0f0"><td style="padding:5px" align="center" height="22"><span id="lblToday"></span></td></tr>');
		}
		...
		if (bPageLoaded) {
			if (crossobj.visibility == 'hidden') {
				...
				*/
				...
				crossobj.left = 50;//(fixedX == -1) ? ctl.offsetLeft + leftpos : fixedX;
				crossobj.top = 0;//(fixedY == -1) ? ctl.offsetTop + toppos - 140 : fixedY;
