<%@ Page Language="vb" AutoEventWireup="false" Inherits="eMicLibAdmin.WebUI.Common.WZFind" EnableViewStateMAC="False" EnableViewState="false" CodeFile="WZFind.aspx.vb" CodeFileBaseClass="eMicLibAdmin.WebUI.clsWBase" %>
...
<HTML>
	...
	<body leftMargin="0" topMargin="0">
		<form id="Form1" method="post" runat="server">
			<table cellSpacing="0" cellPadding="2" width="100%">
				<tr class="lbPageTitle">
					<td>
						<table cellSpacing="0" cellPadding="2" width="100%">
							<tr>
								<td><asp:label id="lblNext" Runat="server" Visible="False">Xem tiếp 10 biểu ghi bắt đầu từ biểu ghi: </asp:label><asp:textbox id="txtNext" Runat="server" Visible="False" Width="56px">11</asp:textbox><asp:button id="btnNext" Runat="server" Visible="False" Width="70px" Text="Xem(v)"></asp:button></td>
				...
				<tr class="lbGridHeader">
					<td align="center"><asp:label id="NotFound" Runat="server" Visible="False" ForeColor="White">Không tìm thấy bản ghi nào thoả mãn điều kiện</asp:label></td>
				</tr>
				<tr class="lbPageTitle">
			...
			</asp:dropdownlist><INPUT id="hidTag020" type="hidden" runat="server"> <INPUT id="hidTag022" type="hidden" runat="server">
