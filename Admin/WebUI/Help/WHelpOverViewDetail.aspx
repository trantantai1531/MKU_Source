<%@ Page Language="vb" AutoEventWireup="false" Inherits="eMicLibAdmin.WebUI.WHelpOverViewDetail" CodeFile="WHelpOverViewDetail.aspx.vb" CodeFileBaseClass="eMicLibAdmin.WebUI.clsWHelpBase" %>
	...
	<body leftMargin="0" topMargin="0">
		<form id="Form1" method="post" runat="server">
			<table style="HEIGHT: 100%" width="100%" border="0">
				...
				<tr>
					<td>
						<asp:Label CssClass="lbPageTitle" Height="100%" Width="100%" Runat="server" ID="lblTitleItemLink">Các chức năng liên quan</asp:Label>
					</td>
				</tr>
				<tr>
					<td align="center">
