...
'Puspose: Manage template refuse
'Creator: Tuanhv
...
Namespace eMicLibAdmin.WebUI.Edeliv
    Partial Class WRefuseTemplateMan
        Inherits clsWBase
...
#End Region
        ...
        Private Sub BindJS()
            ...
            Page.RegisterClientScriptBlock("SelfJs", "<script language = 'javascript'src = '../js/Tool/WRefuseTemplateMan.js'></script>")
            ...
            ddlFormatName.Attributes.Add("OnChange", "javascript:parent.Hiddenbase.location.href='WTemplateLoadInfor.aspx?TemplateID='+ this.value + '&TemplateType=18';document.forms[0].txtTemplate.value=this.value; return false;")
            ...
            btnDelete.Attributes.Add("OnClick", "javascript:EncryptionTags(); if(document.forms[0].ddlFormatName.options[document.forms[0].ddlFormatName.options.selectedIndex].value==0){alert('" & ddlLabel.Items(6).Text.Trim & "'); return false;} else {if(confirm('" & ddlLabel.Items(5).Text & " ')){return true;}else{return false;}};")
        ...
        Private Sub btnDelete_Click(ByVal sender As System.Object, ByVal e As System.EventArgs) Handles btnDelete.Click
            objBETemplate.TemplateID = txtTemplate.Value
            objBETemplate.TemplateType = 18
