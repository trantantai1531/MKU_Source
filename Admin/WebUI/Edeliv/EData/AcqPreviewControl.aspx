<%@ Page Language="VB" AutoEventWireup="false" CodeFile="AcqPreviewControl.aspx.vb" Inherits="eMicLibAdmin.WebUI.Edeliv.Pages_AcqPreviewControl" %>
      ...
      <script type="text/javascript">
        <!--
          ...
          function OnSubmit(key) {
              parent.mainpreview.CheckSubmit(key);
              return;
        }
       //-->
     </script>      
...
<body  class="bgbody" style="margin-top:0;margin-left:0;margin-right:0;margin-bottom:0">
    ...
    <div style="display:none">
        <span  id="span_Toolbar_item0" runat="server">Mở biểu ghi</span>
        <span  id="span_Toolbar_item1" runat="server">Đóng</span>        
    </div>        
    </form>
</body>
</html>
