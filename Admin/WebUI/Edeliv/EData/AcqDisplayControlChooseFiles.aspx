<%@ Page Language="VB" AutoEventWireup="false" CodeFile="AcqDisplayControlChooseFiles.aspx.vb" Inherits="eMicLibAdmin.WebUI.Catalogue.Pages_AcqDisplayControlChooseFiles" %>
        ...
        <!--
          ...
          function RedirectUrl(val) {
            switch (val) {
                case '0':
                    visibleToolbar('',true);
                    parent.maincontentchoosefile.location.href = "AcqDisplayFolder.aspx";
                    break;
                case '1':
                    visibleToolbar('acquisition', true);
                    parent.maincontentchoosefile.location.href = "AcqDisplayCollection.aspx";
                    break;
                case '2':
                    visibleToolbar('acquisition', true);
                    parent.maincontentchoosefile.location.href = "AcqDisplayStatus.aspx";
                    break;
                case '3':
                    visibleToolbar('acquisition', true);
                    parent.maincontentchoosefile.location.href = "AcqDisplayFormat.aspx";
                    break;
            }
         }
       //-->
