<%@ Page Language="VB" AutoEventWireup="false" CodeFile="AcqUploadFilesControl.aspx.vb" Inherits="eMicLibAdmin.WebUI.Edeliv.Pages_AcqUploadFilesControl" %>
      ...
      <script type="text/javascript">
        <!--
          ...
          function OnSubmit(key) {
              parent.mainupload.CheckSubmit(key);
              return;
          }
