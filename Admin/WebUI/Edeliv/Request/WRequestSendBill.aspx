<%@ Page Language="vb" AutoEventWireup="false" Inherits="eMicLibAdmin.WebUI.Edeliv.WRequestSendBill" CodeFile="WRequestSendBill.aspx.vb" %>
<!DOCTYPE HTML PUBLIC "-//W3C//DTD HTML 4.0 Transitional//EN">
<HTML>
	<HEAD>
		<title>Gửi hoá đơn</title>
		...
		<form id="Form1" method="post" runat="server">
			<table cellSpacing="0" cellPadding="2" width="100%" border="0">
				...
				<tr class="lbControlBar">
					<td width="30%"></td>
					<td>
						<asp:button id="btnPrintLetter" Runat="server" Text="In thư(p)" Width="78px"></asp:button>
						<asp:button id="btnSendEmail" Runat="server" Text="Gửi thư(s)" Width="90px"></asp:button>
						<asp:button id="btnClose" Runat="server" Text="Đóng(c)" Width="68px"></asp:button>
					</td>
				</tr>
			</table>
			...
			<asp:dropdownlist id="ddlFooterColumn" Runat="server" Width="0" Height="0" Visible="False">
				<asp:ListItem Value="NAME">Phan Hào Hiệp</asp:ListItem>
				<asp:ListItem Value="DELIVNAME">Công ty cổ phần công nghệ DGSoft</asp:ListItem>
				<asp:ListItem Value="DELIVXADDR">138/7 Duy Tân</asp:ListItem>
				<asp:ListItem Value="DELIVSTREET">Phường 15</asp:ListItem>
			...
			<asp:dropdownlist id="ddlBodyColumn" Runat="server" Width="0" Height="0" Visible="False">
				<asp:ListItem Value="NAME">Phan Hào Hiệp</asp:ListItem>
				<asp:ListItem Value="DELIVNAME">Công ty cổ phần công nghệ DGSoft</asp:ListItem>
				<asp:ListItem Value="DELIVXADDR">138/7 Duy Tân</asp:ListItem>
				<asp:ListItem Value="DELIVSTREET">Phường 15</asp:ListItem>
			...
			<asp:DropDownList Runat="server" ID="ddlLabel" Width="0" Height="0" Visible="False">
				<asp:ListItem Value="0">Hoá đơn thanh toán</asp:ListItem>
				...
				<asp:ListItem Value="7">Bạn chưa chọn khuôn dạng thư!</asp:ListItem>
			</asp:DropDownList>
		</form>
	</body>
</HTML>
