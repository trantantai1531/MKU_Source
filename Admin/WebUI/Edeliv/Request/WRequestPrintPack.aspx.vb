...
Namespace eMicLibAdmin.WebUI.Edeliv
    Partial Class WRequestPrintPack
        Inherits clsWBase
...
#End Region
        ...
        Private Sub SendEmail()
            ...
            Call WriteErrorMssg(ddlLabel.Items(6).Text, objERequest.ErrorMsg, ddlLabel.Items(5).Text, objERequest.ErrorCode)
