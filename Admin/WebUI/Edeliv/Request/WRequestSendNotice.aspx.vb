...
Namespace eMicLibAdmin.WebUI.Edeliv
    Partial Class WRequestSendNotice
        Inherits clsWBase
...
#End Region
        ...
        Private Sub BindScript()
            Page.RegisterClientScriptBlock("ShelfJs", "<script language='javascript' src='../Js/Request/WRequestSendNotice.js'></script>")
        ...
        Private Sub btnPrintLetter_Click(ByVal sender As Object, ByVal e As System.EventArgs) Handles btnPrintLetter.Click
            'Visiable control in form
            Call ActiveControl(False)

            'Get content for letter
            Call PrevieViewLetter()
            lblContents.Text = strContent

            'Create print stop content letter
