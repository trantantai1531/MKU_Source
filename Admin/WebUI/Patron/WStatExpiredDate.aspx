<%@ Page Language="vb" AutoEventWireup="false" Inherits="eMicLibAdmin.WebUI.Patron.WStatExpiredDate" CodeFile="WStatExpiredDate.aspx.vb" CodeFileBaseClass="eMicLibAdmin.WebUI.clsWBase" %>

<!DOCTYPE HTML PUBLIC "-//W3C//DTD HTML 4.0 Transitional//EN">
<html>
<head>
    <title>WStatExpiredDate</title>
...
<body topmargin="0" leftmargin="0">
    <form id="Form1" method="post" runat="server">
        <div id="divBody">
            ...
            <h1 class="main-head-form">Thống kê thời gian hết hạn thẻ</h1>
            <div class="main-form">
                    ...
                    <div class="three-column-form" style="width:30%">
                        <div class="row-detail">
                            <div class="radio-control">
                                <asp:RadioButton ID="optAllYearsExpried" runat="server" Checked="true" GroupName="ExpiredDate" Text="Tấ<u>t</u> cả các năm"></asp:RadioButton>
                                <asp:RadioButton ID="optEachYearExpired" runat="server" GroupName="ExpiredDate" Text="Từn<u>g</u> năm:"></asp:RadioButton>
                        ...
                        <div class="row-detail" style="text-align:right;">
                            <div class="button-control">
                                <div class="button-form">
                                    <label>Đơn vị:</label>
                                    <asp:DropDownList runat="server" ID="ddlFaculty"></asp:DropDownList>
                                    <asp:Button ID="btnStatistic" runat="server" Width="" Text="Thống kê(s)"></asp:Button>
                                </div>
                            </div>
                        </div>
                    </div>
        ...
        <asp:DropDownList ID="ddlLabel" Width="0" runat="server" Visible="False">
            ...
            <asp:ListItem Value="3">Năm hết hạn thẻ không hợp lệ!</asp:ListItem>
