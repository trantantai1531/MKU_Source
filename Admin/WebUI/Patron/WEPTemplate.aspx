<%@ Page Language="vb" AutoEventWireup="false" Inherits="eMicLibAdmin.WebUI.Patron.WEPTemplate" EnableViewState="False" EnableViewStateMAC="False" CodeFile="WEPTemplate.aspx.vb" CodeFileBaseClass="eMicLibAdmin.WebUI.clsWBase" %>
	...
	<body topmargin="0" leftmargin="0" rightmargin="0">
		<form id="Form1" method="post" runat="server">
			<table width="100%" border="0" cellpadding="0" cellspacing="0">
				<tr>
					<td width="100%" align="center"><asp:Label ID="lblMainTitle" Runat="server" Width="100%" CssClass="main-group-form">Xem mẫu khuôn dạng xuất dữ liệu</asp:Label></td>
				</tr>
				<tr align="center">
					<td width="100%">
			...
			<asp:dropdownlist id="ddlInf" Runat="server" Visible="False" Width="0">
				...
				<asp:ListItem Value="IDCARD">09122132</asp:ListItem>
			</asp:dropdownlist>
