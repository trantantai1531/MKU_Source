...
Namespace eMicLibAdmin.WebUI.Patron
    Partial Class WStatClassResult
        Inherits clsWBase
...
#End Region
        ...
        Private Sub GenChart()
            ...
            objBPatronCollection.ClassStat(ddlLabel.Items(6).Text, Request.QueryString("FacultyID"))
            ' Write error
            ...
            If UCase(label(0)) = "NOT FOUND" Then
                ...
                anh2.Visible = False
            Else
                objBCChart.Makebarchart(data, label, ddlLabel.Items(3).Text, ddlLabel.Items(4).Text, 45, strImgURL, "WStatClassResult.aspx")
