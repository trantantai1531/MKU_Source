...
#End Region
        ...
        ' BindJS method
        Private Sub BindJS()
            Page.RegisterClientScriptBlock("WStatOccuResultJs", "<script language='javascript' src='js/WStartIndex.js'></script>")
        End Sub
        ...
        Private Sub GenChart()
            ...
            If Not Request.QueryString("IDs") & "" = "" Then
                objBPatronCollection.OccupationStat(ddlLabel.Items(6).Text, Request.QueryString("IDs"))
                ' Write error
                ...
                If label(0) = "NOT FOUND" Then
                    ...
                    anh2.Visible = False
                Else
                    objBCChart.Makebarchart(data, label, ddlLabel.Items(3).Text, ddlLabel.Items(4).Text, 45, strImgURL, "WStatOccuResult.aspx")
