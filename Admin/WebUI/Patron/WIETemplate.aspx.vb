' Class: WIPTemplate
' Puspose: preview import template
' Creator: Sondp
...
#End Region
        ...
        Private Sub BindJS()
            ...
            Page.RegisterClientScriptBlock("WIETemplateJs", "<script language = 'javascript' src = 'js/WImportTemplate.js'></script>")

            ddlTemplate.Attributes.Add("onchange", "parent.hiddenbase.location.href='WIHTemplate.aspx?TemplateID=' + document.forms[0].ddlTemplate.options[forms[0].ddlTemplate.selectedIndex].value; return false;")
        ...
        Private Sub btnUpdate_Click(ByVal sender As Object, ByVal e As System.EventArgs) Handles btnUpdate.Click
            ...
            Try
                ...
                Else ' Addnew
                    ...
                    If intResult = 1 Then
                        Page.RegisterClientScriptBlock("EXISTS", "<script language='javascript'>alert('" & ddlLabel.Items(14).Text.Trim & "');</script>")
                        Exit Sub
                    End If
            ...
            Catch ex As Exception
                Page.RegisterClientScriptBlock("ActionFailJs", "<script language='javascript'>alert('" & ddlLabel.Items(8).Text & " " & ex.Message & "');</script>")
            End Try
            Call BindData()
        End Sub
