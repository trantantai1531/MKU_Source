<%@ Page Language="vb" AutoEventWireup="false" Inherits="eMicLibAdmin.WebUI.Patron.WStatPatronFaculty" CodeFile="WStatPatronFaculty.aspx.vb" CodeFileBaseClass="eMicLibAdmin.WebUI.clsWBase" %>
<!DOCTYPE HTML PUBLIC "-//W3C//DTD HTML 4.0 Transitional//EN">
<HTML>
	<HEAD>
		<title>WStatPatronFaculty</title>
	...
	<body bgColor="#ffffff" onload="GenURL(7)" topmargin="0" leftmargin="0"
		...
		<form id="Form1" method="post" runat="server">
			<TABLE id="Table1" cellSpacing="1" cellPadding="1" width="100%" align="center" border="0"
				...
				<TR>
					<TD align="center"><img src="" border="0" name="anh1" id="anh1" runat="server"> <img src="" border="0" name="anh2" id="anh2" runat="server">
					</TD>
				</TR>
			</TABLE>
