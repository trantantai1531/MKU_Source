...
Namespace eMicLibAdmin.WebUI.Patron
    Partial Class WStatGradeResult
        Inherits clsWBase
...
#End Region
        ...
        Private Sub GenChart()
            ...
            If Request.QueryString("ID") & "" = "" Then
                objBPatronCollection.GradeStat(ddlLabel.Items(6).Text, 0)
            Else
                objBPatronCollection.GradeStat(ddlLabel.Items(6).Text, CInt(Request.QueryString("ID")))
            End If
            ' Write error
            ...
            If label(0) = "NOT FOUND" Then
                ...
                anh2.Visible = False
            Else
                objBCChart.Makebarchart(data, label, ddlLabel.Items(3).Text, ddlLabel.Items(4).Text, 45, strImgURL, "WStatGradeResult.aspx")
