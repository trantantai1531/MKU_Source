<%@ Page Language="vb" AutoEventWireup="false" Inherits="eMicLibAdmin.WebUI.Patron.WStatExpiredDateResult"
    CodeFile="WStatExpiredDateResult.aspx.vb" CodeFileBaseClass="eMicLibAdmin.WebUI.clsWBase" %>

<!DOCTYPE HTML PUBLIC "-//W3C//DTD HTML 4.0 Transitional//EN">
<html>
<head>
    <title>WStatExpiredDateResult</title>
...
<body bgcolor="#ffffff" leftmargin="0" topmargin="0" onload="GenURL(7)" rightmargin="0">
    <form id="Form1" method="post" runat="server">
  
    <table id="Table1" cellspacing="1" cellpadding="1" width="100%" align="center" bgcolor="#ffffff" border="0">
        <tr align="center">
            <td align="center">
                <asp:Label ID="lblNotFound" CssClass="lbPageTitle" Width="100%" runat="server" Visible="False">Không tìm thấy dữ liệu</asp:Label>
            </td>
        </tr>
        <tr>
            <td align="right">
    ...
    <asp:DropDownList ID="ddlLabel" Width="0" runat="server" Visible="False">
        ...
        <asp:ListItem Value="3">Các năm có thẻ hết hạn</asp:ListItem>
        <asp:ListItem Value="4">Các tháng trong năm</asp:ListItem>
        <asp:ListItem Value="5">Tỉ lệ % theo thẻ hết hạn</asp:ListItem>
        <asp:ListItem Value="6">Số lượng thẻ hết hạn</asp:ListItem>
        <asp:ListItem Value="7">Thống kê số thẻ hết hạn trong các năm, các tháng</asp:ListItem>
    </asp:DropDownList>
        ...
        <asp:Label ID="LabelStaticYear" runat="server" Text="Thống kê số thẻ hết hạn từng năm" Visible="false"></asp:Label>
        <asp:Label ID="LabelStaticMonth" runat="server" Text="Thống kê số thẻ hết hạn từng tháng trong năm" Visible="false"></asp:Label>
    </form>
</body>
</html>
