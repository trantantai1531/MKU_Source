<%@ Page Language="vb" AutoEventWireup="false" Inherits="eMicLibAdmin.WebUI.Patron.WIETemplate" CodeFile="WIETemplate.aspx.vb" CodeFileBaseClass="eMicLibAdmin.WebUI.clsWBase" %>

<!DOCTYPE HTML PUBLIC "-//W3C//DTD HTML 4.0 Transitional//EN">
<html>
<head>
    <title>WIETemplate</title>
...
<body topmargin="0" leftmargin="0" rightmargin="0" onload="document.forms[0].txtTitle.focus()">
    <form id="Form1" method="post" runat="server">
        <div id="divBody">
            <h1 class="main-head-form">Khuôn dạng nhập</h1>
            <div class="main-form">
                <div class="two-column ClearFix">
                    <div class="two-column-form">
                        ...
                        <div class="row-detail">
                            <p>Tên mẫu :</p><asp:label id="lblMan" Runat="server" Font-Bold="True" ForeColor="Red" ToolTip="Trường bắt buộc">(*)</asp:label>
                            <div class="input-control">
                    ...
                    <div class="two-column-form">
                        <div class="row-detail">
                            ...
                            <div class="input-control">
                                <div class="input-form ">
                                    <asp:textbox id="txtContent" Runat="server" Width="" Columns="100" Rows="10" TextMode="MultiLine"
							Height="82px" Wrap="False"></asp:textbox>
                                </div>
                            </div>
                        </div>
                    </div>
        ...
        <asp:DropDownList ID="ddlLabel" runat="server" Visible="False" Width="0">
            ...
            <asp:ListItem Value="9">Tạo mới khuôn dạng nhập</asp:ListItem>
            <asp:ListItem Value="10">Cập nhật khuôn dạng nhập</asp:ListItem>
            <asp:ListItem Value="11">Xoá khuôn dạng nhập</asp:ListItem>
            <asp:ListItem Value="12">thành công</asp:ListItem>
            <asp:ListItem Value="13">Bạn chưa chọn khuôn dạng cần xoá!</asp:ListItem>
            <asp:ListItem Value="14">Khuôn dạng nhập đã tồn tại!</asp:ListItem>
        </asp:DropDownList>
    </form>
</body>
</html>
