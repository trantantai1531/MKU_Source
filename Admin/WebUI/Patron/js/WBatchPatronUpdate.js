...
//		- Boolean value
// For update form
function CheckAllUpdate(strDtgName, strOptionName, intMax, strMess1, strMess2) {
    // Check Code
	if (document.forms[0].txtNewTextValue.value=='' && document.forms[0].txtNewDateValue.value=='' && document.forms[0].ddlOptionFieldValue3.selectedIndex==0){
		alert(strMess1);
		return false;
	}
...
function ClearAll() {
	...
	document.forms[0].ddlFieldName7.options.selectedIndex = 0;
	document.forms[0].ddlFieldName8.options.selectedIndex = 0;
	document.forms[0].txtNewDateValue.value = '';
	document.forms[0].txtNewTextValue.value = '';
	document.forms[0].ddlFieldName9.options.selectedIndex = 0;
	document.forms[0].ddlOptionFieldValue3.options.selectedIndex = 0;
