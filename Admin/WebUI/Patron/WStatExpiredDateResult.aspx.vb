...
Namespace eMicLibAdmin.WebUI.Patron
    Partial Class WStatExpiredDateResult
        Inherits clsWBase
...
#End Region
        ...
        ' Method: BindJS
        Private Sub BindJS()
            Page.RegisterClientScriptBlock("WStatExpiredDateResultJs", "<script language='javascript' src='js/WStartIndex.js'></script>")
        End Sub
        ...
        Private Sub GenChart()
            ...
            If Not Request.QueryString("Year") & "" = "" Then
                ...
                If Not label Is Nothing AndAlso label(0) = "NOT FOUND" Then
                    lblNotFound.Visible = True
                    anh1.Visible = False
                    anh2.Visible = False
                Else
                    If Request.QueryString("Year") = "0" Then
                        objBCChart.Makebarchart(data, label, ddlLabel.Items(6).Text, ddlLabel.Items(3).Text, 0, strImgURL, "WStatExpiredDateResult.aspx")
                    Else
                        objBCChart.Makebarchart(data, label, ddlLabel.Items(6).Text, ddlLabel.Items(4).Text & ":" & Request.QueryString("Year"), 0, strImgURL, "WStatExpiredDateResult.aspx")
                    End If
        ...
        Private Sub BindData()
            ...
            Dim strFromDate = Session("DateExpiredFrom").ToString
            Dim strDateTo = Session("DateExpiredTo").ToString
            objBPatronCollection.Faculty = Session("FacultyID")
            'Dim intYear As Integer = CInt(Request.QueryString("Year"))
            objBPatronCollection.LibID = clsSession.GlbSite
            tblResult = objBPatronCollection.ExpiredDateStatDetailDHVL(strFromDate, strDateTo)
            lblTotal.Text = "0"
        ...
        Protected Sub btnExport_Click(sender As Object, e As EventArgs) Handles btnExport.Click
            ...
            If strFromDate & "" <> "" AndAlso strDateTo <> "" Then
                ...
                'Dim intYear As Integer = CInt(Request.QueryString("Year"))
                objBPatronCollection.LibID = clsSession.GlbSite
                tblData = objBPatronCollection.ExpiredDateStatDetailDHVL(strFromDate, strDateTo)
