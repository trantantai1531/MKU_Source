    ...
    Public Class clsDOPACHelp
        ...
        Public Function GetInforSearch() As DataTable
            ...
            Select Case UCase(strDBServer)
                ...
                Case "ORACLE"
                    With oraCommand
                        .CommandText = "OPAC.Lib_spHelpCatDic_SelToSearch"
                        .CommandType = CommandType.StoredProcedure
                        Try
                            With .Parameters
        ...
        Public Function DeleteHelp() As Boolean
            ...
            Select Case UCase(strDBServer)
                ...
                Case "ORACLE"
                    With oraCommand
                        .CommandText = "OPAC.Lib_spHelpCatDic_Sel"
                        .CommandType = CommandType.StoredProcedure
                        Try
                            With .Parameters
        ...
        Public Function UpdatetHelp() As Boolean
            ...
            Select Case UCase(strDBServer)
                ...
                Case "ORACLE"
                    With oraCommand
                        .CommandText = "OPAC.Lib_spHelpCatDic_Upd"
                        .CommandType = CommandType.StoredProcedure
                        Try
                            With .Parameters
                                .Add(New OracleParameter("intDicID", OracleType.Number)).Value = intCatDicID
        ...
        Public Function InsertHelp() As Boolean
            ...
            Select Case UCase(strDBServer)
                ...
                Case "ORACLE"
                    With oraCommand
                        .CommandText = "OPAC.Lib_spHelpCatDic_Ins"
                        .CommandType = CommandType.StoredProcedure
                        Try
                            With .Parameters
        ...
        Public Function GetHepCatFileByURL() As DataTable
            ...
            Select Case UCase(strDBServer)
                ...
                Case "ORACLE"
                    With oraCommand
                        .CommandText = "OPAC.Lib_spHelpCatFile_SelByFileUrl"
                        .CommandType = CommandType.StoredProcedure
                        Try
                            With .Parameters
                                .Add(New OracleParameter("strFileURL", OracleType.VarChar)).Value = strFileURL
        ...
        Public Function GetHepCatFileByDicID() As DataTable
            ...
            Select Case UCase(strDBServer)
                ...
                Case "ORACLE"
                    With oraCommand
                        .CommandText = "OPAC.Lib_spHelpCatFile_SelByCatDicId"
                        .CommandType = CommandType.StoredProcedure
                        Try
                            With .Parameters
        ...
        Public Function GetHepCatDicByID() As DataTable
            ...
            Select Case UCase(strDBServer)
                ...
                Case "ORACLE"
                    With oraCommand
                        .CommandText = "OPAC.Lib_spHelpCatDic_SelByDicId"
                        .CommandType = CommandType.StoredProcedure
                        Try
                            With .Parameters
        ...
        Public Function GetHepItemLinkByID() As DataTable
            ...
            Select Case UCase(strDBServer)
                ...
                Case "ORACLE"
                    With oraCommand
                        .CommandText = "OPAC.Lib_spHelpItemLink_SelByCatDicId"
                        .CommandType = CommandType.StoredProcedure
                        Try
                            With .Parameters
                                .Add(New OracleParameter("intCatDicID", OracleType.Number)).Value = intCatDicID
        ...
        Public Function GetHepDicItemByID() As DataTable
            ...
            Select Case UCase(strDBServer)
                ...
                Case "ORACLE"
                    With oraCommand
                        .CommandText = "OPAC.Lib_spHelpDicItem_SelByCatDicID"
                        .CommandType = CommandType.StoredProcedure
                        Try
                            With .Parameters
                                .Add(New OracleParameter("intCatDicID", OracleType.Number)).Value = intCatDicID
        ...
        Public Function GetHepCatDicByParentID() As DataTable
            ...
            Select Case UCase(strDBServer)
                ...
                Case "ORACLE"
                    With oraCommand
                        .CommandText = "OPAC.Lib_spHelpCatDic_SelByParentId"
                        .CommandType = CommandType.StoredProcedure
                        Try
                            With .Parameters
                                .Add(New OracleParameter("intParentID", OracleType.Number)).Value = intParentID
