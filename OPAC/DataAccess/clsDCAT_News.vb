...
#End Region
        ...
        Public Function CAT_News_up_vi_tri() As Integer
            ...
            Select Case UCase(strDBServer)
                Case "SQLSERVER"
                    With sqlCommand
                        .CommandText = "Cat_spCatNew_UpdViTri"
                        .CommandType = CommandType.StoredProcedure
                        Try
                            With .Parameters
                                .Add(New SqlParameter("@id", SqlDbType.Int)).Value = idStr
                ...
                Case "SQLSERVER"
                    With sqlCommand
                        ...
                        Try
                            .Parameters.Add(New SqlParameter("@NN", SqlDbType.NVarChar, 10)).Value = NNStr
                            .Parameters.Add(New SqlParameter("@id_L", SqlDbType.NVarChar, 10)).Value = id_LStr
                            .Parameters.Add(New SqlParameter("@id_C", SqlDbType.NVarChar, 10)).Value = id_CStr
                            sqlDataAdapter.SelectCommand = sqlCommand
                            sqlDataAdapter.Fill(dsData, "tblResult")
        ...
        Public Function CAT_News_sl_id(Optional ByVal intLibID As Integer = 0) As DataTable
            Call OpenConnection()
            Select Case UCase(strDBServer)
                Case "ORACLE"
                Case "SQLSERVER"
        ...
        Public Function CAT_News_SelectId_L(Optional ByVal intLibID As Integer = 0) As DataTable
            Call OpenConnection()
            Select Case UCase(strDBServer)
                Case "ORACLE"
                Case "SQLSERVER"
                    With sqlCommand
                        .CommandText = "Cat_spCatNew_SelById_L"
                        .CommandType = CommandType.StoredProcedure
                        Try
                            .Parameters.Add(New SqlParameter("@id_L", SqlDbType.NVarChar, 4000)).Value = id_LStr
                            .Parameters.Add(New SqlParameter("@NN", SqlDbType.NVarChar, 10)).Value = NNStr
                            .Parameters.Add(New SqlParameter("@intLibID", SqlDbType.Int)).Value = intLibID
                            .Parameters.Add(New SqlParameter("@PageNum", SqlDbType.Int)).Value = intPageNum
                            .Parameters.Add(New SqlParameter("@PageSize", SqlDbType.Int)).Value = intPageSize
                            sqlDataAdapter.SelectCommand = sqlCommand
                            sqlDataAdapter.Fill(dsData, "tblResult")
        ...
        Public Function CAT_News_SelectIndex(Optional ByVal intLibID As Integer = 0) As DataTable
            Call OpenConnection()
            Select Case UCase(strDBServer)
                Case "ORACLE"
                Case "SQLSERVER"
