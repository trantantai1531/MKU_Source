...
#End Region
        ...
        Public Function CAT_Type_sl(Optional ByVal intLibID As Integer = 0) As DataTable
            Try
                objType.id_L = id_LStr
                objType.NN = NNStr
                CAT_Type_sl = objBCDBS.ConvertTable(objType.CAT_Type_sl(intLibID))
        ...
        Public Function CAT_Type_sl_id(Optional ByVal intLibID As Integer = 0) As DataTable
            Try
                objType.id = idStr
                CAT_Type_sl_id = objBCDBS.ConvertTable(objType.CAT_Type_sl_id(intLibID))
                strErrorMsg = objBCDBS.ErrorMsg
                intErrorCode = objBCDBS.ErrorCode
                'Catch ex As Exception
                '    strErrorMsg = ex.Message
