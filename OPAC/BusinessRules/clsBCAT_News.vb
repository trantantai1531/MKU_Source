...
#End Region
        ...
        Public Function CAT_News_sl_admin() As DataTable
            Try
                objNews.NN = NNStr
                objNews.id_L = id_LStr
                CAT_News_sl_admin = objBCDBS.ConvertTable(objNews.CAT_News_sl_admin)
                strErrorMsg = objNews.ErrorMsg
        ...
        Public Function CAT_News_sl_id(Optional ByVal intLibID As Integer = 0) As DataTable
            Try
                objNews.id = idStr
                CAT_News_sl_id = objBCDBS.ConvertTable(objNews.CAT_News_sl_id(intLibID))
                strErrorMsg = objNews.ErrorMsg
                intErrorCode = objNews.ErrorCode
                'Catch ex As Exception
                '    strErrorMsg = ex.Message
        ...
        Public Function CAT_News_SelectId_L(Optional ByVal intLibID As Integer = 0) As DataTable
            Try
                objNews.id_L = id_LStr
                objNews.NN = NNStr
                objNews.PageNum = PageNum
                objNews.PageSize = PageSize
                CAT_News_SelectId_L = objBCDBS.ConvertTable(objNews.CAT_News_SelectId_L(intLibID))
                strErrorMsg = objNews.ErrorMsg
                intErrorCode = objNews.ErrorCode
                'Catch ex As Exception
                '    strErrorMsg = ex.Message
        ...
        Public Function CAT_News_SelectIndex(Optional ByVal intLibID As Integer = 0) As DataTable
            Try
                objNews.NN = NNStr
                CAT_News_SelectIndex = objBCDBS.ConvertTable(objNews.CAT_News_SelectIndex(intLibID))
                strErrorMsg = objNews.ErrorMsg
                intErrorCode = objNews.ErrorCode
                'Catch ex As Exception
                '    strErrorMsg = ex.Message
