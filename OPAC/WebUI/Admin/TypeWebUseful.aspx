<%@ Page Title="" Language="vb" AutoEventWireup="false" MasterPageFile="~/Admin/Admin.Master" CodeBehind="TypeWebUseful.aspx.vb" Inherits="eMicLibOPAC.WebUI.OPAC.TypeWebUseful" %>
...
<div id="page-wrapper">
    <div class="row">
        <div class="col-lg-12">
            <h1 class="page-header">Website hữu ích</h1>
        </div>
        <!-- /.col-lg-12 -->
    </div>
    <!-- /.row -->
