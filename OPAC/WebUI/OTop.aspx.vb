...
Namespace eMicLibOPAC.WebUI.OPAC
    Public Class OTop
        ...
        Private Function getLenString(ByVal val) As String
            Return Len(val)
        End Function


        Private Sub BindJavascript()
            'Page.RegisterClientScriptBlock("MainJs", "<script language='javascript' src='JS/OTop.js'></script>")
        End Sub
        ...
        Private Sub raiseLogout_Click(ByVal sender As Object, ByVal e As System.EventArgs) Handles raiseLogout.Click
            spAccount.InnerText = spHello.InnerText & Space(1) & spGuest.InnerText & "!"
            spLoginLogout.InnerText = spLogin.InnerText
