<%@ Page Language="vb" AutoEventWireup="false" CodeBehind="ODictionary.aspx.vb" Inherits="eMicLibOPAC.WebUI.OPAC.ODictionary" %>
    ...
    <form id="form1" runat="server">
        ...
        <div id="divMain">
            <div class="web-size sort-page ClearFix">
                <h1><span class="mif-brightness-auto"></span>TRA TỪ ĐIỂN</h1>
                <h2>Nhập vào từ vựng cần tìm kiếm:</h2>
                    ...
                    $(function () {
                        ...
                        $("[id$=txtSearchVocabulary]").autocomplete({
                            source: function (request, response) {
                                ...
                                $.ajax({
                                    url: '<%=ResolveUrl("~/ODictionary.aspx/GetVocabulary")%>',
                            ...
                            select: function (e, i) {
                                ...
                                $("[id$=txtSearchVocabulary]").val(i.item.val);
                                $("[id$=btnSearchVocabulary]").click();
                            },
                            minLength: 1
                        });
                    });
                ...
                <asp:DropDownList ID="dllDictionaryType" runat="server">
                    <asp:ListItem Selected="True" Value="1">Anh-Việt</asp:ListItem>
                    <asp:ListItem Value="2">Việt-Anh</asp:ListItem>
                </asp:DropDownList>
                <asp:Button ID="btnSearchVocabulary" runat="server" Text="Tra Cứu" />
                <br />


                <asp:Label ID="Label1" runat="server" Text="Nghĩa của từ: " Font-Bold="True"></asp:Label>
