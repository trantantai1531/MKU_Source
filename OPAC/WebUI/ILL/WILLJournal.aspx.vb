...
#End Region
        ...
        Private Sub BindScript()
            ...
            Page.RegisterClientScriptBlock("SelfJs", "<script language = 'javascript' src = '../js/ILL/WILLJournal.js'></script>")
        ...
        Private Sub PostRequest()
            ...
            objBILLOut.ArticleAuthor = txtAuthor.Text
            objBILLOut.ArticleTitle = txtTitle.Text
            objBILLOut.Note = strNote
            objBILLOut.Title = txtTitle.Text
            Dim strVolumeIssue As String
            If txtIssueNum.Text <> "" Then
                strVolumeIssue = txtVolume.Text & " (" & txtIssueNum.Text & ")"
            Else
                strVolumeIssue = txtVolume.Text
            End If
            objBILLOut.Pagination = txtPageNum.Text
            objBILLOut.VolumeIssue = strVolumeIssue
