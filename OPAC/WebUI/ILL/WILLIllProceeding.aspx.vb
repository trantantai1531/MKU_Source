...
Namespace eMicLibOPAC.WebUI.OPAC
    Partial Class WILLIllProceeding
        Inherits clsWBase
...
#End Region
        ...
        Private Sub BindScript()
            ...
            Page.RegisterClientScriptBlock("SelfJs", "<script language = 'javascript' src = '../js/ILL/WILLProceeding.js'></script>")
        ...
        Private Sub PostRequest()
            ...
            strNote = ""
            If txtTimeAndLocation.Text <> "" Then
                strNote = strNote & Trim(txtTimeAndLocation.Text) & ". "
            End If
