...
#End Region
        ...
        Private Sub BindScript()
            ...
            Page.RegisterClientScriptBlock("SelfJs", "<script language = 'javascript' src = '../js/ILL/WILLChapter.js'></script>")
            ...
            btnPostRequest.Attributes.Add("Onclick", "javascript:return CheckValid('" & lblMsg1.Text & "','" & lblMsg2.Text & "','" & lblMsg3.Text & "','" & lblMsg4.Text & "','" & lblMsg5.Text & "','" & lblMsg6.Text & "','" & lblMsg7.Text & "','" & lblMsgInvalidDate.Text & "');")
            btnReset.Attributes.Add("OnClick", "javascript:document.forms[0].reset();return false;")
            'lnkPubDate.Attributes.Add("onclick", "OpenWindow('../Common/WCalendar.aspx?id=opener.document.forms[0].txtExpireDate','Calendar',200,256,220,100);return false;")
            Me.RegisterCalendar("../")
            SetOnclickCalendar(lnkPubDate, "txtExpireDate")
        End Sub
        ...
        Private Sub PostRequest()
            ...
            objBILLOut.Title = txtBookName.Text
            objBILLOut.Author = txtBookAuthor.Text
            objBILLOut.ArticleAuthor = txtChapterAuthor.Text
            objBILLOut.ArticleTitle = txtChapterTitle.Text
            objBILLOut.Pagination = txtPage.Text
            objBILLOut.Publisher = txtPublisher.Text
