<%@ Page Language="vb" AutoEventWireup="false" Inherits="eMicLibOPAC.WebUI.OPAC.WILLGoverment" Codebehind="WILLGoverment.aspx.vb" %>
<!DOCTYPE HTML PUBLIC "-//W3C//DTD HTML 4.0 Transitional//EN">
<HTML>
	<HEAD>
		<title>WILLGoverment</title>
	...
	<body leftMargin="0" topMargin="0" onload="ResetCtlValue();ChangeFontType();document.forms[0].txtSponsoringBody.focus();">
		<form id="Form1" method="post" runat="server">
					...
					<td>
						<table width="100" border="0" cellpadding="0" cellspacing="0">
							...
							<tr>
								...
								<td width="115" background="../Images/ImgViet/title_bg.gif" align="left" style="WIDTH: 118px"><asp:label id="lblTitleIllGoverment" CssClass="lbTitleHeader" Runat="server">ILL</asp:label></td>
							</tr>
						</table>
					</td>
				</tr>
			...
			<table cellSpacing="0" cellPadding="2" width="100%" border="0">
				<tr>
					<td colSpan="2"><asp:label CssClass="lbPageTitle" Width="100%" id="lblMainTitle" Runat="server">Yêu cầu mượn Báo cáo của chính phủ</asp:label></td>
				</tr>
				<tr>
					<td align="right" width="30%"><asp:label id="lblSponsoringBody" Runat="server">Cơ quan ban hành:</asp:label></td>
					<td width="70%"><asp:textbox id="txtSponsoringBody" Runat="server" Width="400"></asp:textbox></td>
				</tr>
				<tr>
					<td align="right"><asp:label id="lblTitle" Runat="server">Tiêu đề báo cáo:</asp:label></td>
				...
				<tr>
					<td colspan="2">
						<asp:label id="lblMsg1" Runat="server" Visible="False">Tiêu đề báo cáo</asp:label>
