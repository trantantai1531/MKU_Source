...
#End Region
        ...
        Private Sub BindScript()
            ...
            Page.RegisterClientScriptBlock("SelfJs", "<script language = 'javascript' src = '../js/ILL/WILLTechnical.js'></script>")
        ...
        Private Sub PostRequest()
            ...
            If txtMaxCost.Text <> "" Then If txtMaxCost.Text <> "" Then objBILLOut.MaxCost = txtMaxCost.Text
            ...
            objBILLOut.SeriesTitleNumber = txtReportNum.Text
