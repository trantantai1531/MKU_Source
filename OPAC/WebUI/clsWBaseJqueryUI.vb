...
Namespace eMicLibOPAC.WebUI
    Public Class clsWBaseJqueryUI
        ...
        Private objPara() As String = {"OPAC_FORUM_URL", "LDAP_LOCATION", "LDAP_SERVER_TYPE", "LDAP_LOGON_USER", "LDAP_LOGON_PASSWORD", "SMTP_SERVER", "ADMIN_EMAIL_ADDRESS", "EDATA_LOCATIONS", "OPAC_URL", "DATE_FORMAT", "OPAC_SERVER_LOCAL", "OPAC_SERVER_PUBLIC", "OPAC_PHYSICAL_PATH", "OPAC_PICTURE_PATH", "ROOT_SITE", "OPAC_CATALOGUER_PATH"}
        ...
        Private Sub checklicense()
            If IsNothing(Application("licenseOpac")) Or Not Application("licenseOpac") Then
                Response.Redirect("~/License/MLLicense.aspx")
                Response.End()
            End If
        End Sub
        ...
        Private Function checkValidSite() As Boolean
            ...
            Try
                If Not IsNothing(clsSession.GlbSite) AndAlso clsSession.GlbSite >= 1 Then
                Else
                    If InStr(Request.ServerVariables("SCRIPT_NAME").ToLower, "odefault.aspx") <= 0 AndAlso InStr(Request.ServerVariables("SCRIPT_NAME").ToLower, "omap.aspx") <= 0 Then
                        bolResult = False
                    End If
                End If
            Catch ex As Exception
        ...
        Private Sub setDefaultMetadata()
            Try
                ...
                '    .Content = "www.emiclib.com: Tài liệu số trực tuyến Emiclib. Kết nối và chia sẻ nguồn tri thức, những người yêu và đam mê đọc sách."
                'End With
                'head.Controls.Add(hm)
                'hm = New HtmlMeta
                'With hm
                ...
                'End With
                'head.Controls.Add(hm)
                head.Title = "Trường Đại Học Cửu Long"
            Catch ex As Exception
            End Try
        End Sub
        ...
        Public Sub PageInit()
            ...
            'Page.RegisterClientScriptBlock("jqueryJsgoogleajax", "<Script Language='JavaScript'  type='text/javascript' src='Resources/StyleSheet/ssc/java/googleajax-jquery-ui.min-1.8.2.js'></Script>")
            'Page.RegisterClientScriptBlock("jqueryJs", "<Script Language='JavaScript'  type='text/javascript' src='Resources/StyleSheet/ssc/java/jssor/jquery-1.9.1.min.js'></Script>")
        ...
        Private Sub setLanguage()
            Try
                ...
                If Not IsNothing(Request("Lang")) AndAlso Request("Lang") <> "" Then
        ...
        Private Sub ReadXmlFile()
            ...
            '        If Not IsNothing(dsResource.Tables) Then
        ...
        Public Function GetStyleSheetURL_Metro() As String
            ...
            'strResults &= vbCrLf
            'strResults &= vbCrLf
            strResults &= String.Format("<meta content=""{0}"" name=""viewport"" />", String.Format("width=device-width, initial-scale=1, maximum-scale=1"))
            strResults &= vbCrLf
            strResults &= String.Format("<meta http-equiv=""{0}"" content=""{1}""></meta>", "X-UA-Compatible", "IE=100")
            strResults &= vbCrLf
            strResults &= String.Format("<meta http-equiv=""{0}"" content=""{1}""></meta>", "Content-Type", "text/html; charset=utf-8")
            strResults &= vbCrLf
            'strResults &= String.Format("<link href=""{0}"" rel=""shortcut icon""></link>", String.Format("Resources/StyleSheet/ssc/images/design/logo.ico"))
            strResults &= String.Format("<link href=""{0}"" rel=""shortcut icon""></link>", String.Format("Images/favicon-32x32.png"))
            strResults &= vbCrLf
            strResults &= String.Format("<link href=""{0}"" type=""text/css"" rel=""StyleSheet""></link>", String.Format("Resources/StyleSheet/ssc/styles/default.css"))
            strResults &= vbCrLf
            strResults &= String.Format("<link href=""{0}"" type=""text/css"" rel=""StyleSheet""></link>", String.Format("Resources/StyleSheet/ssc/styles/main.css"))
            strResults &= vbCrLf
            strResults &= String.Format("<link href=""{0}"" type=""text/css"" rel=""StyleSheet""></link>", String.Format("Resources/StyleSheet/ssc/styles/iconFont.css"))
            strResults &= vbCrLf
            strResults &= String.Format("<link href=""{0}"" type=""text/css"" rel=""StyleSheet""></link>", String.Format("Resources/StyleSheet/ssc/styles/metro-icons.css"))
            strResults &= vbCrLf
            strResults &= String.Format("<link href=""{0}"" type=""text/css"" rel=""StyleSheet""></link>", String.Format("Resources/StyleSheet/ssc/styles/color.css"))
            strResults &= vbCrLf
            strResults &= String.Format("<link href=""{0}"" type=""text/css"" rel=""StyleSheet""></link>", String.Format("Resources/StyleSheet/magnific/magnific-popup.css"))
            strResults &= vbCrLf
            strResults &= String.Format("<link href=""{0}"" type=""text/css"" rel=""StyleSheet"" media=""all""></link>", String.Format("Resources/StyleSheet/ssc/styles/media.css"))
            'strResults &= vbCrLf
            'strResults &= String.Format("<link href=""{0}""  rel=""StyleSheet"">", String.Format("Resources/StyleSheet/ssc/java/owl/owl.carousel.css"))
            'strResults &= vbCrLf
            'strResults &= String.Format("<link href=""{0}""  rel=""StyleSheet"">", String.Format("Resources/StyleSheet/ssc/java/owl/owl.theme.css"))

            strResults &= vbCrLf
            strResults &= String.Format("<script Language=""JavaScript""  type=""text/javascript"" src=""{0}""></script>", String.Format("Resources/StyleSheet/ssc/java/googleajax-jquery-ui.min-1.8.2.js"))
            strResults &= vbCrLf
            strResults &= String.Format("<script Language=""JavaScript""  type=""text/javascript"" src=""{0}""/></script>", String.Format("Resources/StyleSheet/ssc/java/jssor/jquery-2.1.3.min.js"))
            strResults &= vbCrLf
            strResults &= String.Format("<script Language=""JavaScript""  type=""text/javascript"" src=""{0}""/></script>", String.Format("JS/magnific/jquery.magnific-popup.min.js"))
            strResults &= vbCrLf
            strResults &= String.Format("<script Language=""JavaScript""  type=""text/javascript"" src=""{0}""/></script>", String.Format("Resources/StyleSheet/ssc/java/metro.js"))
            Return strResults
        End Function
        ...
        Public Function getEDataPATH() As String
            ...
            Return strResult
        End Function
        Public Function getCatalogerPATH() As String
            Dim strResult As String = ""
            Try
                strResult = objSysPara(15)
            Catch ex As Exception
            End Try
            Return strResult
        End Function
        ...
        Public Function getRootSiteAdmin() As String
            Dim strResult As String = ""
            Try
                strResult = objSysPara(14)
            Catch ex As Exception
            End Try
            Return strResult
        End Function
        ...
        Public Function Send2Mail(ByVal strSubject As String, ByVal strContent As String, ByVal strEmail As String) As Integer
            ...
            Try
                ...
                Dim mailClient As New Mail.SmtpClient(strSMTPServer, strSMTPPort)
                With mailClient
                    .Timeout = 15000
                ...
                With mailMessage
                    ...
                    .IsBodyHtml = True
                    .From = New Mail.MailAddress(strSMTPMailUser)
                    .Subject = strSubject
                    .Priority = Net.Mail.MailPriority.Normal
                    .Body = strContent
                End With

                Dim arrEmail() As String = strEmail.Split(",")

                For Each item As String In arrEmail
